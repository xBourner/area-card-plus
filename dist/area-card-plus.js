 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Os, defineProperty: ks, getOwnPropertyDescriptor: zs, getOwnPropertyNames: Ps, getOwnPropertySymbols: Ds, getPrototypeOf: Is } = Object, le = globalThis, s1 = le.trustedTypes, Ts = s1 ? s1.emptyScript : "", ct = le.reactiveElementPolyfillSupport, ze = (t, e) => t, tt = { toAttribute(t, e) {
  switch (e) {
    case Boolean:
      t = t ? Ts : null;
      break;
...
let be = class extends HTMLElement {
  ...
  static getPropertyDescriptor(e, s, i) {
    const { get: o, set: n } = zs(this.prototype, e) ?? { get() {
      return this[s];
    }, set(a) {
      this[s] = a;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(ze("properties"))) {
      const s = this.properties, i = [...Ps(s), ...Ds(s)];
...
be.elementStyles = [], be.shadowRootOptions = { mode: "open" }, be[ze("elementProperties")] = /* @__PURE__ */ new Map(), be[ze("finalized")] = /* @__PURE__ */ new Map(), ct == null || ct({ ReactiveElement: be }), (le.reactiveElementVersions ?? (le.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Pe = globalThis, st = Pe.trustedTypes, o1 = st ? st.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, Cs = "$lit$", ne = `lit$${Math.random().toFixed(9).slice(2)}$`, vs = "?" + ne, Zs = `<${vs}>`, ve = document, De = () => ve.createComment(""), Ie = (t) => t === null || typeof t != "object" && typeof t != "function", zt = Array.isArray, Bs = (t) => zt(t) || typeof (t == null ? void 0 : t[Symbol.iterator]) == "function", lt = `[ 	
\f\r]`, ke = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, n1 = /-->/g, a1 = />/g, me = RegExp(`>|${lt}(?:([^\\s"'>=/]+)(${lt}*=${lt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), r1 = /'/g, c1 = /"/g, ys = /^(?:script|style|textarea|title)$/i, Ns = (t) => (e, ...s) => ({ _$litType$: t, strings: e, values: s }), g = Ns(1), X = Symbol.for("lit-noChange"), H = Symbol.for("lit-nothing"), l1 = /* @__PURE__ */ new WeakMap(), ge = ve.createTreeWalker(ve, 129);
function Ls(t, e) {
...
const Rs = (t, e) => {
  ...
  for (let r = 0; r < s; r++) {
    const c = t[r];
    let l, p, h = -1, f = 0;
    for (; f < c.length && (a.lastIndex = f, p = a.exec(c), p !== null); ) f = a.lastIndex, a === ke ? p[1] === "!--" ? a = n1 : p[1] !== void 0 ? a = a1 : p[2] !== void 0 ? (ys.test(p[2]) && (o = RegExp("</" + p[2], "g")), a = me) : p[3] !== void 0 && (a = me) : a === me ? p[0] === ">" ? (a = o ?? ke, h = -1) : p[1] === void 0 ? h = -2 : (h = a.lastIndex - p[2].length, l = p[1], a = p[3] === void 0 ? me : p[3] === '"' ? c1 : r1) : a === c1 || a === r1 ? a = me : a === n1 || a === a1 ? a = ke : (a = me, o = void 0);
    const u = a === me && t[r + 1].startsWith("/>") ? " " : "";
    n += a === ke ? c + Zs : h >= 0 ? (i.push(l), c.slice(0, h) + Cs + c.slice(h) + ne + u) : c + ne + (h === -2 ? r : u);
  }
...
class Te {
  constructor({ strings: e, _$litType$: s }, i) {
    ...
    this.parts = [];
    let n = 0, a = 0;
    const r = e.length - 1, c = this.parts, [l, p] = Rs(e, s);
    ...
    for (; (o = ge.nextNode()) !== null && c.length < r; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const h of o.getAttributeNames()) if (h.endsWith(Cs)) {
          const f = p[a++], u = o.getAttribute(h).split(ne), _ = /([.?@])?(.*)/.exec(f);
          c.push({ type: 1, index: n, name: _[2], strings: u, ctor: _[1] === "." ? Us : _[1] === "?" ? js : _[1] === "@" ? Ws : nt }), o.removeAttribute(h);
        } else h.startsWith(ne) && (c.push({ type: 6, index: n }), o.removeAttribute(h));
        if (ys.test(o.tagName)) {
          const h = o.textContent.split(ne), f = h.length - 1;
          if (f > 0) {
            o.textContent = st ? st.emptyScript : "";
            for (let u = 0; u < f; u++) o.append(h[u], De()), ge.nextNode(), c.push({ type: 2, index: ++n });
            o.append(h[f], De());
          }
        }
...
class xe {
  ...
  _$AI(e, s = this) {
    e = Me(this, e, s), Ie(e) ? e === H || e == null || e === "" ? (this._$AH !== H && this._$AR(), this._$AH = H) : e !== this._$AH && e !== X && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Bs(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  k(e) {
    ...
    const s = this._$AH;
    let i, o = 0;
    for (const n of e) o === s.length ? s.push(i = new xe(this.O(De()), this.O(De()), this, this.options)) : i = s[o], i._$AI(n), o++;
...
const Gs = { I: xe }, ht = Pe.litHtmlPolyfillSupport;
ht == null || ht(Te, xe), (Pe.litHtmlVersions ?? (Pe.litHtmlVersions = [])).push("3.3.1");
const As = (t, e, s) => {
  const i = (s == null ? void 0 : s.renderBefore) ?? e;
  let o = i._$litPart$;
  if (o === void 0) {
    const n = (s == null ? void 0 : s.renderBefore) ?? null;
    i._$litPart$ = o = new xe(e.insertBefore(De(), n), n, void 0, s ?? {});
  }
  return o._$AI(t), o;
};
/**
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Pt = { ATTRIBUTE: 1, CHILD: 2 }, Ne = (t) => (...e) => ({ _$litDirective$: t, values: e });
let Re = class {
  constructor(e) {
  }
  get _$AU() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const bs = "important", ti = " !" + bs, O = Ne(class extends Re {
  constructor(t) {
    var e;
...
const m1 = (t, e, s) => {
  ...
  update(t, [e, s, i]) {
    ...
    let l, p, h = 0, f = o.length - 1, u = 0, _ = n.length - 1;
    for (; h <= f && u <= _; ) if (o[h] === null) h++;
    else if (o[f] === null) f--;
    else if (r[h] === a[u]) c[u] = _e(o[h], n[u]), h++, u++;
    else if (r[f] === a[_]) c[_] = _e(o[f], n[_]), f--, _--;
    else if (r[h] === a[_]) c[_] = _e(o[h], n[_]), fe(t, c[_ + 1], o[h]), h++, _--;
    else if (r[f] === a[u]) c[u] = _e(o[f], n[u]), fe(t, o[h], o[f]), f--, u++;
    else if (l === void 0 && (l = m1(a, u, _), p = m1(r, h, f)), l.has(r[h])) if (l.has(r[f])) {
      const d = p.get(a[u]), m = d !== void 0 ? o[d] : null;
      if (m === null) {
        const y = fe(t, o[h]);
        _e(y, n[u]), c[u] = y;
      } else c[u] = _e(m, n[u]), fe(t, o[h], m), o[d] = null;
      u++;
    } else ut(o[f]), f--;
    else ut(o[h]), h++;
    for (; u <= _; ) {
...
const Dt = ["sensor"], It = ["binary_sensor"], Tt = ["cover"], Lt = ["climate"], No = ["camera"], Qe = [
  ...
  (t, e) => Dt.flatMap((s) => s in t ? e[s].map(
    (i, o) => ({
      domain: s,
      deviceClass: i,
      index: o
  ...
  if (typeof t == "object")
    return Object.entries(t).reduce((n, [a, r]) => {
      const c = a.startsWith("--") ? a : a.replace(/-([a-z])/g, (l, p) => p.toUpperCase());
  ...
  const o = t.replace(/\/\*[\s\S]*?\*\//g, "").replace(/\n/g, " ").split(";").map((n) => n.trim()).filter((n) => n && n.includes(":")).reduce((n, a) => {
    ...
    if (c && l !== void 0) {
      const p = c.trim(), h = p.startsWith("--") ? p : p.replace(/-([a-z])/g, (f, u) => u.toUpperCase());
      n[h] = l.trim();
    }
    return n;
  }, {});
...
`, Q = [
  ...
  if (n === "default" && ((h = t.__themes) == null ? void 0 : h.cacheKey) === "default")
    return;
  if (n && n !== "default" && ((f = e == null ? void 0 : e.themes) != null && f[n])) {
    const { modes: m, ...y } = e.themes[n] || {};
    c = { ...c, ...y }, m && (a && m.dark ? c = { ...c, ...m.dark } : !a && m.light && (c = { ...c, ...m.light }));
  } else if (!n && (!((u = t.__themes) != null && u.keys) || t.__themes.keys.size === 0))
    return;
  const l = ((_ = t.__themes) == null ? void 0 : _.keys) || /* @__PURE__ */ new Set(), p = new Set(Object.keys(c));
  ...
  if (((d = t.__themes) == null ? void 0 : d.cacheKey) === r) {
    let m = !0;
    if (l.size !== p.size)
      m = !1;
    else
  ...
  for (const [m, y] of Object.entries(c))
    t.style.setProperty(`--${m}`, String(y));
  t.__themes.cacheKey = r || null, t.__themes.keys = p;
}, Z = (t, e, s, i) => {
  i = i || {}, s = s ?? {};
  const o = new Event(e, {
...
), gn = (t, e) => t < e ? -1 : t > e ? 1 : 0, Cn = (t, e, s = void 0) => Intl != null && Intl.Collator ? fn(s).compare(t, e) : gn(t.toLowerCase(), e.toLowerCase()), vn = (t) => {
  switch (t.language) {
    case "cs":
    case "de":
    case "fi":
...
let qe;
const yn = async (t) => qe || (qe = t.callWS({
...
const Ct = (t, e) => {
  ...
  if (e === "domain") {
    ...
    if (f) {
      ...
      if (s !== "binary_sensor" && s !== "sensor")
        if (s === "climate") {
          const d = (h = (p = t._config) == null ? void 0 : p.customization_domain) == null ? void 0 : h.find(
            (y) => y.type === "climate"
          ), m = d == null ? void 0 : d.display_mode;
          (m === "icon" || m === "text_icon") && t._showPopupForDomain(s);
        } else
  ...
  if (e === "custom_button" && (o != null && o.entity) && c) {
    const f = o.entity, u = new CustomEvent("hass-more-info", {
      bubbles: !0,
      composed: !0,
      detail: { entityId: f }
    });
...
const Ht = (t, e) => {
  ...
  if (!s || s.length === 0)
    return;
  let o;
  const n = s.filter((r) => !pn(r) || isNaN(Number(r.state)) ? !1 : o ? r.attributes.unit_of_measurement === o : (o = r.attributes.unit_of_measurement, !0));
  if (!n.length)
    return;
  const a = n.reduce((r, c) => r + Number(c.state), 0);
  return e === "power" ? `${ns(a, i, {
    maximumFractionDigits: 1
  })}${o ? rs(o, i) : ""}${o || ""}` : `${ns(a / n.length, i, {
    maximumFractionDigits: 1
  })}${o ? rs(o, i) : ""}${o || ""}`;
}, us = (t, e, s) => {
  if (t in Ze) {
...
var Mn = Object.defineProperty, he = (t, e, s, i) => {
  for (var o = void 0, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (o = a(e, s, o) || o);
  return o && Mn(e, s, o), o;
};
const wn = /* @__PURE__ */ new Set(), xn = [ee, Q], Bt = class Bt extends Y {
  constructor() {
    super(...arguments), this._onPopState = (e) => {
      ...
      (e, s, i, o, n, a, r) => {
        const c = new Set(
          ...
          r
        ), p = s == null ? void 0 : s.category_filter, h = (f) => $e(f, e, p);
        return l.filter((f) => {
          if (!h(f)) return !1;
          const u = I(f);
          return !(n.length > 0 && !n.includes(u) || a && u !== a);
        });
      }
    ), this.computeLabel = A(
  ...
  async _createCardElement(e, s, i = !1) {
    ...
    try {
      ...
      return typeof p.setConfig == "function" && p.setConfig(s), p.hass = e, (a = p.setAttribute) == null || a.call(p, "data-hui-card", ""), p;
    } catch {
      if (!i)
  ...
  _getPopupCardConfig(e) {
    var u, _, d, m, y, $, V, C, L, w, k;
    const s = this.card, i = I(e.entity_id), o = this.selectedDomain || i, n = this.selectedDomain ? this.selectedDeviceClass : (m = (d = (_ = (u = this.hass) == null ? void 0 : u.states) == null ? void 0 : _[e.entity_id]) == null ? void 0 : d.attributes) == null ? void 0 : m.device_class, a = (s == null ? void 0 : s._config) || {};
    let r;
    It.includes(o) ? (r = (y = a.customization_alert) == null ? void 0 : y.find(
      (M) => M.type === n
    ), r || (r = ($ = a.customization_domain) == null ? void 0 : $.find(
      (M) => M.type === o
    ))) : Dt.includes(o) ? (r = (V = a.customization_sensor) == null ? void 0 : V.find(
      (M) => M.type === n
    ...
    const c = r == null ? void 0 : r.popup_card, l = c && typeof c.type == "string" && c.type || (r == null ? void 0 : r.popup_card_type) || "tile", p = l === "tile" ? this.DOMAIN_FEATURES[i] ?? {} : {};
    let h = {};
  ...
  _getAreaEntitiesContext() {
    var a;
    const e = this.card, s = (a = e._config) == null ? void 0 : a.area, i = e._devices && Array.isArray(e._devices) ? e._devices : e.hass && e.hass.devices ? e.hass.devices : {}, o = this.hass && this.hass.devices && this.hass.entities ? ae(this.hass.entities, this.hass.devices) : void 0, n = o ? wn : ce(s, i);
  ...
  shouldUpdate(e) {
    ...
    const { areaId: o, devicesInArea: n, entitiesIndex: a } = this._getAreaEntitiesContext(), r = this._getCandidateEntityIds(
      ...
      a
    ), c = ((p = i._config) == null ? void 0 : p.extra_entities) || [];
    for (const h of r)
  ...
  _isActive(e) {
    return !xn.flat().includes(e.state);
  }
  sortEntitiesForPopup(e) {
    ...
    if (s === "state") {
      ...
      return i.sort((c, l) => {
        const p = this._isActive(c) ? 0 : 1, h = this._isActive(l) ? 0 : 1;
        if (p !== h) return p - h;
        const f = I(c.entity_id), u = I(l.entity_id), _ = this.hass ? hs(this.hass, c.state, f) : c.state, d = this.hass ? hs(this.hass, l.state, u) : l.state, m = (_ || "").localeCompare(d || "");
        return m !== 0 ? m : r(c.entity_id, l.entity_id);
      });
    }
    const o = Ve(
      this.hass.states,
  ...
  render() {
    var L, w, k, M, v, S, D, T, z;
    if (!this.hass || !this.card) return g``;
    const e = this.card, { areaId: s, devicesInArea: i, entitiesIndex: o } = this._getAreaEntitiesContext(), n = this.hass.states, a = ((L = e._config) == null ? void 0 : L.popup_domains) || [], r = ((w = e._config) == null ? void 0 : w.extra_entities) || [], c = (k = e._config) == null ? void 0 : k.hide_unavailable, l = (M = e._config) == null ? void 0 : M.category_filter, p = this.selectedDomain || null, h = this.selectedDeviceClass || null, f = (b) => $e(b, this.hass.entities, l);
    let u = [];
    this.entities && this.entities.length > 0 ? u = this.entities.reduce((b, E) => {
      const x = E.entity_id;
      if (!f(x)) return b;
      const B = I(x);
      return a.length > 0 && !a.includes(B) || p && B !== p || b.push(x), b;
    ...
    for (const b of u) {
      const E = n[b];
      E && (c && ee.includes(E.state) || h && E.attributes.device_class !== h || _.push(E));
    }
    for (const b of r) {
      const E = I(b), x = n[b];
      x && (a.length > 0 && !a.includes(E) || p && E !== p || h && x.attributes.device_class !== h || f(b) && !_.some((B) => B.entity_id === b) && _.push(x));
    }
    const d = ((v = e == null ? void 0 : e._config) == null ? void 0 : v.ungroup_areas) === !0;
    let m = (S = e._config) != null && S.columns ? e._config.columns : 4, y = [], $ = [];
    if (d)
      $ = this.sortEntitiesForPopup(_), m = Math.min(m, Math.max(1, $.length));
    else {
      const b = {};
      for (const R of _) {
      ...
      y = Object.entries(b).filter(([R]) => !p || R === p).sort(([R], [G]) => {
        const Se = x.indexOf(R), Ee = x.indexOf(G);
        return (Se === -1 ? x.length : Se) - (Ee === -1 ? x.length : Ee);
      }).map(
        ([R, G]) => [R, this.sortEntitiesForPopup(G)]
      );
      const B = y.length ? Math.max(...y.map(([, R]) => R.length)) : 0;
      m = Math.min(m, Math.max(1, B));
    }
    if (this.style.setProperty("--columns", String(m)), !(y.length > 0 || $.length > 0))
      return g`
        <ha-adaptive-dialog
          .hass=${this.hass}
          .open=${this.open}
      ...
      `;
    const C = Vt((D = e._config) == null ? void 0 : D.area, (T = e.hass) == null ? void 0 : T.areas) ?? null;
    return g`
      <ha-adaptive-dialog
        .hass=${this.hass}
        .open=${this.open}
      ...
      >
        ...
        <span slot="headerTitle">
          ${((z = e._config) == null ? void 0 : z.area_name) || C && C.name}
        </span>
...
var Sn = Object.defineProperty, En = Object.getOwnPropertyDescriptor, de = (t, e, s, i) => {
  for (var o = i > 1 ? void 0 : i ? En(e, s) : e, n = t.length - 1, a; n >= 0; n--)
...
let se = class extends Y {
    ...
    super(...arguments), this.selectedDomain = null, this.selectedDeviceClass = null, this.selectedGroup = null, this._currentCameraIndex = 0, this._iconCache = /* @__PURE__ */ new Map(), this._styleCache = /* @__PURE__ */ new Map(), this._deviceClasses = At, this._customizationDomainMap = /* @__PURE__ */ new Map(), this._customizationCoverMap = /* @__PURE__ */ new Map(), this._customizationAlertMap = /* @__PURE__ */ new Map(), this._customizationSensorMap = /* @__PURE__ */ new Map(), this._actionHandlerCache = /* @__PURE__ */ new Map(), this._hiddenEntitiesSet = /* @__PURE__ */ new Set(), this._excludedEntitiesSet = /* @__PURE__ */ new Set(), this._getOrganizedEntities = A(
      (t, e, s) => {
        ...
        for (const n of t) {
          ...
          if (!a) continue;
          const r = I(n);
          if (!Qe.includes(r) && !Dt.includes(r) && !It.includes(r) && !Tt.includes(r) && !No.includes(r) && !Lt.includes(r))
            continue;
  ...
  _isOn(t, e, s) {
    ...
    if (s)
      ...
      ).filter((p) => p.split(".")[0] === t).map((p) => this.hass.states[p]).filter((p) => p !== void 0);
    }
    if (i.length)
      return (e ? i.filter(
  ...
  _renderEntityGroup(t, e, s, i) {
    var p, h, f, u;
    const o = t === "cover", n = o ? "open" : "on", a = o ? (p = this._config) == null ? void 0 : p.cover_color : (h = this._config) == null ? void 0 : h.alert_color, r = o ? (f = this._config) == null ? void 0 : f.cover_css : (u = this._config) == null ? void 0 : u.alert_css, c = o ? "cover" : "alert", l = o ? (_, d) => $n(this, _, d) : (_, d) => Vn(this, _, d);
    return g`
      <div class="${J({ [t + "s"]: !0, ...this._designClasses })}">
        ${te(
      e,
      (_) => _.domain + "-" + _.deviceClass,
      ({ domain: _, deviceClass: d }) => {
        var k, M, v, S, D, T;
        const m = i.get(d), y = (m == null ? void 0 : m.invert) === !0, V = (((k = s.get(_)) == null ? void 0 : k.get(d)) || []).filter((z) => {
          var E;
          const b = z.state === n;
          return (y ? Q.includes(z.state) : b) && !this._excludedEntitiesSet.has(z.entity_id) && $e(z.entity_id, this.hass.entities, (E = this._config) == null ? void 0 : E.category_filter);
        }), C = (m == null ? void 0 : m.color) || a, L = m == null ? void 0 : m.icon, w = V.length;
        return w > 0 ? g`
                  <div
                    class="icon-with-count hover"
                    style=${O(this._getParsedCss(
          ((M = m == null ? void 0 : m.styles) == null ? void 0 : M.button) || ((v = m == null ? void 0 : m.styles) == null ? void 0 : v.card) || r || ((D = (S = this._config) == null ? void 0 : S.styles) == null ? void 0 : D[c]),
          m
        ))}
                    @action=${l(_, d)}
                    .actionHandler=${q(m)}
                  >
                    ${this._renderIcon(
          L || this._cachedIcon(_, !y, d),
          O({
            ...C ? { color: `var(--${C}-color)` } : {},
            ...this._getParsedCss((T = m == null ? void 0 : m.styles) == null ? void 0 : T.icon, m)
          }),
          t
        )}
  ...
  renderCustomButtons(t) {
    ...
    return !((e = this._config) != null && e.custom_buttons) || this._config.custom_buttons.length === 0 ? H : g`
      ...
      var c, l, p, h;
      if (s.conditional) {
        const f = s.entity ? I(s.entity) : null;
        if (f && f in t) {
          const u = t[f].find(
            (_) => _.entity_id === s.entity
          );
          if (!u || ee.includes(u.state) || Q.includes(u.state))
            return H;
        }
      }
      let i;
      ...
      if (!a && i && (a = i.attributes.icon, !a)) {
        const f = I(i.entity_id), u = !ee.includes(i.state) && !Q.includes(i.state);
        a = us(f, u, i.attributes.device_class);
      }
      const r = !!s.name;
      return g`
            <div
        ...
        O({
          ...n,
          ...this._getParsedCss(((p = s.styles) == null ? void 0 : p.icon) || s.icon_css, s)
        })
      ) : H}
  ...
  _renderButtons(t, e, s) {
    return g`
      ...
      (i) => i,
      (i) => {
        var d, m, y, $, V, C, L, w, k, M;
        if (i === "climate") {
          const v = s.get("climate"), S = v == null ? void 0 : v.display_mode;
          if (v && v.hide === !0 || S !== "icon" && S !== "text_icon")
            return H;
        }
        const o = s.get(i), n = (o == null ? void 0 : o.color) || ((d = this._config) == null ? void 0 : d.domain_color), a = o == null ? void 0 : o.icon, r = i === "climate" ? s.get("climate") : void 0, c = r == null ? void 0 : r.display_mode, l = r == null ? void 0 : r.show_set_temperature, p = i === "climate" && (c === "icon" || c === "text_icon") && l === !0, h = e[i].filter((v) => !(ee.includes(v.state) || this._excludedEntitiesSet.has(v.entity_id)));
        let f = [], u;
        if (p) {
          f = h;
          let v = !1, S = !1;
          for (const D of h) {
            const T = ((m = D.attributes) == null ? void 0 : m.hvac_action) ?? null, z = (D.state ?? "").toString().toLowerCase();
            if (T != null) {
              const b = T.toString().toLowerCase();
              v = v || b.includes("heat") || b.includes("heating"), S = S || b.includes("cool") || b.includes("cooling");
            } else
              v = v || z.includes("heat") || z.includes("heating"), S = S || z.includes("cool") || z.includes("cooling");
            if (v && S) break;
          }
          v ? u = this._getClimateColor("heat", "red") : S ? u = this._getClimateColor("cool", "cornflowerblue") : u = this._getClimateColor("standby", "") || ((y = this._config) == null ? void 0 : y.climate_standby_color);
        } else
          f = h.filter((v) => {
            var S;
            if (i === "climate") {
              const D = (S = v.attributes) == null ? void 0 : S.hvac_action;
              if (D != null) {
                const z = D.toString().toLowerCase();
                return !(z === "off" || z === "idle");
              }
        ...
        const _ = f.length;
        return this._config.show_active && _ === 0 ? H : g`
              <div
                class="icon-with-count hover"
                style=${O(
          this._getParsedCss(
          ...
          O({
            ...u ? { color: u } : {},
            ...!u && n ? { color: `var(--${n}-color)` } : {},
            ...!u && !n && ((k = this._config) != null && k.domain_color) ? { color: this._config.domain_color } : {},
  ...
  _renderSensors(t, e, s, i, o) {
    ...
    return g`
      ...
      ({ domain: c, deviceClass: l, index: p }) => {
        var L, w, k, M, v, S, D, T, z, b, E;
        const f = (((L = s.get(c)) == null ? void 0 : L.get(l)) || []).filter(
          (x) => {
            var B;
        ...
        switch (l) {
          case "temperature":
            u = i.temperature_entity_id;
            break;
          case "humidity":
            u = i.humidity_entity_id;
            break;
        }
        const _ = u ? this.hass.states[u] : void 0, d = o.get(l), m = (d == null ? void 0 : d.color) || ((w = this._config) == null ? void 0 : w.sensor_color), y = (d == null ? void 0 : d.invert) === !0, $ = f.some(
        ...
        const V = (k = this._config) != null && k.show_sensor_icons ? g`<ha-domain-icon
          ...
          ...m ? { color: `var(--${m}-color)` } : {},
          ...this._getParsedCss(
            ((M = d == null ? void 0 : d.styles) == null ? void 0 : M.icon) || (d == null ? void 0 : d.css),
            d
          )
        })}
                      .hass=${this.hass}
          ...
          ...this._getParsedCss(
            ((D = d == null ? void 0 : d.styles) == null ? void 0 : D.sensor) || ((T = d == null ? void 0 : d.styles) == null ? void 0 : T.button) || ((z = d == null ? void 0 : d.styles) == null ? void 0 : z.card) || (d == null ? void 0 : d.css),
            d
          )
        })}
                >
                  ${!((b = this._config) != null && b.show_sensor_icons) && !((E = this._config) != null && E.wrap_sensor_icons) && p > 0 ? " - " : ""}
    ...
    return g`
      ...
      ({ domain: i }) => {
        ...
        if ((n == null ? void 0 : n.show_set_temperature) === !0) {
          const d = o.filter(($) => !this._excludedEntitiesSet.has($.entity_id)).map(($) => {
            var z, b, E, x, B, R;
            const V = ((z = $.attributes) == null ? void 0 : z.temperature) ?? ((b = $.attributes) == null ? void 0 : b.target_temperature) ?? null;
            if (V == null) return null;
            const C = Number(V);
            if (Number.isNaN(C)) return null;
            const L = ((B = (x = (E = this.hass) == null ? void 0 : E.config) == null ? void 0 : x.unit_system) == null ? void 0 : B.temperature) || "", w = ((R = $.attributes) == null ? void 0 : R.hvac_action) ?? null, k = ($.state ?? "").toString().toLowerCase(), M = (w ?? k).toString().toLowerCase(), v = M.includes("heat") || M.includes("heating"), S = M.includes("cool") || M.includes("cooling"), D = v ? this._getClimateStyle("heat") : S ? this._getClimateStyle("cool") : this._getClimateStyle("standby"), T = D.color || (v ? "red" : S ? "cornflowerblue" : "var(--secondary-text-color)");
          ...
          const m = d.reduce(
            ...
            ...this._getParsedCss(
              ((p = n == null ? void 0 : n.styles) == null ? void 0 : p.button) || ((h = n == null ? void 0 : n.styles) == null ? void 0 : h.card) || (n == null ? void 0 : n.css),
              n
            )
          };
          return g`<div
        ...
        const r = (o || []).filter((d) => {
          var L;
          const m = (L = d.attributes) == null ? void 0 : L.hvac_action, y = d.state, $ = !ee.includes(y) && !Q.includes(y) && !this._excludedEntitiesSet.has(d.entity_id);
          if (m != null) {
            const w = m.toString().toLowerCase();
            return $ && (w !== "idle" && w !== "off");
          }
          ...
          var y, $, V, C;
          return `${((y = d.attributes) == null ? void 0 : y.temperature) ?? "N/A"} ${((C = (V = ($ = this.hass) == null ? void 0 : $.config) == null ? void 0 : V.unit_system) == null ? void 0 : C.temperature) || ""}`;
        });
        if (r.length === 0)
          return H;
        const c = n == null ? void 0 : n.color, l = {
          ...c ? { color: `var(--${c}-color)` } : {},
          ...!c && ((f = this._config) != null && f.domain_color) ? { color: this._config.domain_color } : {},
          ...this._getParsedCss(
            ((u = n == null ? void 0 : n.styles) == null ? void 0 : u.button) || ((_ = n == null ? void 0 : n.styles) == null ? void 0 : _.card) || (n == null ? void 0 : n.css),
            n
          )
        };
        return g`<div
  ...
  _renderBottom(t, e, s, i, o, n, a) {
    ...
    return g`
      ...
      ...this._getParsedCss(
        ((l = (c = this._config) == null ? void 0 : c.styles) == null ? void 0 : l.name) || ((p = this._config) == null ? void 0 : p.name_css),
        this._config
      )
    })}
  ...
  render() {
    var b, E, x, B, R, G, Se, Ee, Nt, Rt, Ft, Ut, jt, Wt;
    ...
    const h = Vt(this._config.area, ((B = this.hass) == null ? void 0 : B.areas) || {}), f = this._customizationDomainMap, u = this._customizationCoverMap, _ = this._customizationAlertMap, d = this._customizationSensorMap, m = this._computeCovers(p, this._deviceClasses), y = this._computeAlerts(p, this._deviceClasses), $ = this._computeButtons(
      this._config.toggle_domains,
      p
    ), V = this._computeSensors(p, this._deviceClasses), C = ((G = (R = this._config) == null ? void 0 : R.toggle_domains) != null && G.includes("climate") ? Lt : []).filter((j) => j in p).map((j) => ({ domain: j })), L = (((Se = this._config) == null ? void 0 : Se.display_type) || "").toString().toLowerCase(), w = L.includes("camera"), k = L.includes("picture") || L.includes("image"), M = L === "" ? !0 : L.includes("icon"), v = w ? p.camera || [] : [], S = w && (this._config.camera_entity || this._config.camera_entity_left || this._config.camera_entity_right);
    if (h === null)
      return g`
        <hui-warning>
      ...
      `;
    const D = w && (v.length > 0 || S) || k && h.picture, T = Wo(
      t,
      i,
      ...
      this._styleCache
    ), z = this.layout === "grid" || this.layout === "panel";
    return g`
      <ha-card
        class="${J(s)}"
        style=${O(
      ...
      >
        <div
          class="header"
          style=${D ? "padding-bottom:0em" : "padding-bottom:12em"}
          @action=${this._handleAction}
          .actionHandler=${q(this._config)}
        >
          <div
            class="picture"
            style=${z ? H : "max-height:12em;"}
          >
            ${(() => {
...
const On = A(() => [{ name: "area", selector: { area: {} } }]), kn = A(
  (t, e, s, i, o) => {
              ...
              select: {
                options: [
                  ...
                  const c = (h) => {
                    ...
                    return f === "icon" ? "ui.panel.lovelace.editor.card.generic.icon" : f === "picture" || f === "image" ? "ui.components.selectors.image.image" : f === "camera" ? "ui.panel.lovelace.editor.card.area.display_type_options.camera" : `ui.panel.lovelace.editor.card.area.display_type_options.${h}`;
                  }, p = r.split(" & ").map((h) => h.trim()).map((h) => n(c(h)) || h).join(" & ");
...
var Bn = Object.defineProperty, Nn = Object.getOwnPropertyDescriptor, F = (t, e, s, i) => {
  for (var o = i > 1 ? void 0 : i ? Nn(e, s) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (o = (i ? a(e, s, o) : a(o)) || o);
...
var Rn = Object.defineProperty, Fn = Object.getOwnPropertyDescriptor, ue = (t, e, s, i) => {
  for (var o = i > 1 ? void 0 : i ? Fn(e, s) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (o = (i ? a(e, s, o) : a(o)) || o);
...
var Wn = Object.defineProperty, Kn = Object.getOwnPropertyDescriptor, K = (t, e, s, i) => {
...
let U = class extends Y {
  ...
  _classesForArea(t, e, s, i, o) {
    ...
    const n = ae(i, o), a = n ? _s : ce(t, o), r = re(
      ...
      void 0,
      n
    ), c = ((f = this._config) == null ? void 0 : f.extra_entities) || [], l = r.map((u) => this.hass.states[u]).filter((u) => u !== void 0);
    if (e === "toggle") {
      const u = l.filter(
        (_) => Qe.includes(I(_.entity_id)) || Lt.includes(I(_.entity_id))
      );
      return [...new Set(u.map((_) => I(_.entity_id)))];
    }
    if (e === "all") {
      const u = c.map((d) => this.hass.states[d]).filter((d) => d !== void 0), _ = [...l, ...u];
      return [...new Set(_.map((d) => I(d.entity_id)))];
    }
    const h = l.filter(
      (u) => {
        var _;
        return I(u.entity_id) === e && !((_ = i[u.entity_id]) != null && _.entity_category);
      }
  ...
  async updated(t) {
    ...
    if (super.updated(t), !(!this.hass || !this._config)) {
      if (t.has("_config")) {
        ...
        if (i !== void 0 && i !== o) {
          ...
          if (this._config.toggle_domains = [
            ...d.filter((V) => V !== "scene" && V !== "script")
          ], this._config.alert_classes = [...f], this._config.cover_classes = [...u], this._config.popup_domains = [...$], this._config.customization_domain = [], this._config.customization_alert = [], this._config.customization_cover = [], this._config.customization_sensor = [], this._updateEntityOptions(), Array.isArray(this._config.hidden_entities)) {
      ...
      if (!this._numericDeviceClasses) {
        const { numeric_device_classes: s } = await yn(this.hass);
  ...
  _renderSubElementEditor(t, e, s) {
    var p, h, f;
    const i = `customization_${t}`, o = (p = this._config) == null ? void 0 : p[i], n = `_subElementEditor${t.charAt(0).toUpperCase() + t.slice(1)}`, a = ((h = this[n]) == null ? void 0 : h.index) ?? 0, r = ((f = o == null ? void 0 : o[a]) == null ? void 0 : f.type) ?? "unknown", c = r.match(/^(.+?)\s*-\s*(.+)$/);
    let l;
    if (c) {
      const u = c[1].toLowerCase().replace(" ", "_"), _ = c[2].toLowerCase(), d = this.hass.localize(`component.${u}.entity_component._.name`) || c[1];
      let m = this.hass.localize(
        `ui.dialogs.entity_registry.editor.device_classes.${u}.${_}`
      ) || c[2];
      m = m.charAt(0).toUpperCase() + m.slice(1), l = `${d} – ${m}`;
    } else {
  ...
  _groupByDeviceClass(t, e) {
    ...
    for (const l of e) {
      const p = ((c = (r = s[l]) == null ? void 0 : r.attributes) == null ? void 0 : c.device_class) || "";
  ...
  _hiddenEntitiesByDomain() {
    ...
    const s = ((f = this.hass) == null ? void 0 : f.entities) || {}, i = ((u = this.hass) == null ? void 0 : u.devices) || {}, o = (_ = this.hass) != null && _.areas ? Object.values(this.hass.areas) : [], n = (d = this._config) == null ? void 0 : d.area, a = (m = this._config) == null ? void 0 : m.floor, r = (y = this._config) == null ? void 0 : y.label, c = n ? Array.isArray(n) ? n : [n] : [], l = a ? Array.isArray(a) ? a : [a] : [], p = r ? Array.isArray(r) ? r : [r] : [];
    for (const $ of e) {
      const V = I($), C = s[$], L = C != null && C.device_id ? i[C.device_id] : void 0;
      if (((C == null ? void 0 : C.area_id) != null || (L == null ? void 0 : L.area_id) != null) && !(p.length && !(Array.isArray(C == null ? void 0 : C.labels) && C.labels.some((M) => p.includes(M)) || Array.isArray(L == null ? void 0 : L.labels) && L.labels.some((M) => p.includes(M)))) && !(c.length && !(C != null && C.area_id && c.includes(C.area_id) || L != null && L.area_id && c.includes(L.area_id)))) {
        if (l.length) {
  ...
  render() {
    ...
    const t = this._toggleDomainsForArea(
      ...
      o,
      this.hass.locale.language
    ), a = this._binaryschema(this.binarySelectOptions), r = this._coverschema(this.coverSelectOptions), c = this._sensorschema(this.sensorSelectOptions), l = this._toggleschema(this.toggleSelectOptions), p = this._popupschema(
      ...
      (u) => g`
            ...
            return g`
                                            <div class="entity-row">
                                              <span class="entity-name">
                                                ${((y = (m = this.hass.states[d]) == null ? void 0 : m.attributes) == null ? void 0 : y.friendly_name) || d}
                                              </span>
                                              <ha-icon-button
                                                .path=${this._isHiddenEntity(d) ? pt : O1}
              ...
              "ui.common.hide"
                                                ...
                                                @click=${() => this._toggleEntityHidden(d)}
                                              ></ha-icon-button>
                                              <ha-icon-button
        ...
        (_) => {
          ...
          return g`
                                    <div class="entity-row">
                                      <span class="entity-name">
                                        ${((m = (d = this.hass.states[_]) == null ? void 0 : d.attributes) == null ? void 0 : m.friendly_name) || _}
                                      </span>
                                      <ha-icon-button
            ...
            "ui.common.hide"
                                      ...
                                      ></ha-icon-button>
                                      <ha-icon-button
                                        .path=${this._isExcludedEntity(_) ? k1 : z1}
