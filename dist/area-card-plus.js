 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: gs, defineProperty: Cs, getOwnPropertyDescriptor: vs, getOwnPropertyNames: ys, getOwnPropertySymbols: Ls, getPrototypeOf: As } = Object, de = globalThis, Rt = de.trustedTypes, Hs = Rt ? Rt.emptyScript : "", dt = de.reactiveElementPolyfillSupport, ze = (t, e) => t, ot = { toAttribute(t, e) {
  switch (e) {
    case Boolean:
      t = t ? Hs : null;
      break;
...
Ve.elementStyles = [], Ve.shadowRootOptions = { mode: "open" }, Ve[ze("elementProperties")] = /* @__PURE__ */ new Map(), Ve[ze("finalized")] = /* @__PURE__ */ new Map(), dt == null || dt({ ReactiveElement: Ve }), (de.reactiveElementVersions ?? (de.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const De = globalThis, nt = De.trustedTypes, Ft = nt ? nt.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, ss = "$lit$", le = `lit$${Math.random().toFixed(9).slice(2)}$`, is = "?" + le, bs = `<${is}>`, Ae = document, Te = () => Ae.createComment(""), Ze = (t) => t === null || typeof t != "object" && typeof t != "function", zt = Array.isArray, Vs = (t) => zt(t) || typeof (t == null ? void 0 : t[Symbol.iterator]) == "function", ut = `[ 	
\f\r]`, ke = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Ut = /-->/g, Wt = />/g, me = RegExp(`>|${ut}(?:([^\\s"'>=/]+)(${ut}*=${ut}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Kt = /'/g, Gt = /"/g, os = /^(?:script|style|textarea|title)$/i, $s = (t) => (e, ...s) => ({ _$litType$: t, strings: e, values: s }), m = $s(1), te = Symbol.for("lit-noChange"), $ = Symbol.for("lit-nothing"), qt = /* @__PURE__ */ new WeakMap(), ye = Ae.createTreeWalker(Ae, 129);
function ns(t, e) {
...
const Ms = (t, e) => {
  ...
  for (let a = 0; a < s; a++) {
    const c = t[a];
    let l, p, h = -1, _ = 0;
    for (; _ < c.length && (r.lastIndex = _, p = r.exec(c), p !== null); ) _ = r.lastIndex, r === ke ? p[1] === "!--" ? r = Ut : p[1] !== void 0 ? r = Wt : p[2] !== void 0 ? (os.test(p[2]) && (o = RegExp("</" + p[2], "g")), r = me) : p[3] !== void 0 && (r = me) : r === me ? p[0] === ">" ? (r = o ?? ke, h = -1) : p[1] === void 0 ? h = -2 : (h = r.lastIndex - p[2].length, l = p[1], r = p[3] === void 0 ? me : p[3] === '"' ? Gt : Kt) : r === Gt || r === Kt ? r = me : r === Ut || r === Wt ? r = ke : (r = me, o = void 0);
    const u = r === me && t[a + 1].startsWith("/>") ? " " : "";
    n += r === ke ? c + bs : h >= 0 ? (i.push(l), c.slice(0, h) + ss + c.slice(h) + le + u) : c + le + (h === -2 ? a : u);
  }
...
class Ie {
  constructor({ strings: e, _$litType$: s }, i) {
    ...
    for (; (o = ye.nextNode()) !== null && c.length < a; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const h of o.getAttributeNames()) if (h.endsWith(ss)) {
          const _ = p[r++], u = o.getAttribute(h).split(le), d = /([.?@])?(.*)/.exec(_);
          c.push({ type: 1, index: n, name: d[2], strings: u, ctor: d[1] === "." ? xs : d[1] === "?" ? Es : d[1] === "@" ? Ss : ht }), o.removeAttribute(h);
        } else h.startsWith(le) && (c.push({ type: 6, index: n }), o.removeAttribute(h));
        if (os.test(o.tagName)) {
          const h = o.textContent.split(le), _ = h.length - 1;
          if (_ > 0) {
            o.textContent = nt ? nt.emptyScript : "";
            for (let u = 0; u < _; u++) o.append(h[u], Te()), ye.nextNode(), c.push({ type: 2, index: ++n });
            o.append(h[_], Te());
          }
        }
...
class xe {
  ...
  constructor(e, s, i, o) {
    this.type = 2, this._$AH = $, this._$AN = void 0, this._$AA = e, this._$AB = s, this._$AM = i, this.options = o, this._$Cv = (o == null ? void 0 : o.isConnected) ?? !0;
  }
  get parentNode() {
  ...
  _$AI(e, s = this) {
    e = Me(this, e, s), Ze(e) ? e === $ || e == null || e === "" ? (this._$AH !== $ && this._$AR(), this._$AH = $) : e !== this._$AH && e !== te && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Vs(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== $ && Ze(this._$AH) ? this._$AA.nextSibling.data = e : this.T(Ae.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var n;
...
class ht {
  ...
  constructor(e, s, i, o, n) {
    this.type = 1, this._$AH = $, this._$AN = void 0, this.element = e, this.name = s, this._$AM = o, this.options = n, i.length > 2 || i[0] !== "" || i[1] !== "" ? (this._$AH = Array(i.length - 1).fill(new String()), this.strings = i) : this._$AH = $;
  }
  _$AI(e, s = this, i, o) {
    ...
    if (n === void 0) e = Me(this, e, s, 0), r = !Ze(e) || e !== this._$AH && e !== te, r && (this._$AH = e);
      ...
      const a = e;
      let c, l;
      for (e = n[0], c = 0; c < n.length - 1; c++) l = Me(this, a[i + c], s, c), l === te && (l = this._$AH[c]), r || (r = !Ze(l) || l !== this._$AH[c]), l === $ ? e = $ : e !== $ && (e += (l ?? "") + n[c + 1]), this._$AH[c] = l;
    }
    r && !o && this.j(e);
  }
  j(e) {
...
class Ss extends ht {
  ...
  _$AI(e, s = this) {
    if ((e = Me(this, e, s, 0) ?? $) === te) return;
    const i = this._$AH, o = e === $ && i !== $ || e.capture !== i.capture || e.once !== i.once || e.passive !== i.passive, n = e !== $ && (i === $ || o);
...
const ks = { I: xe }, pt = De.litHtmlPolyfillSupport;
pt == null || pt(Ie, xe), (De.litHtmlVersions ?? (De.litHtmlVersions = [])).push("3.3.1");
const as = (t, e, s) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const zs = { attribute: !0, type: String, converter: ot, reflect: !1, hasChanged: kt }, Ds = (t = zs, e, s) => {
...
function O(t) {
  return (e, s) => typeof s == "object" ? Ds(t, e, s) : ((i, o, n) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Dt = { ATTRIBUTE: 1, CHILD: 2 }, We = (t) => (...e) => ({ _$litDirective$: t, values: e });
let Ke = class {
  constructor(e) {
  }
  get _$AU() {
  ...
  update(t, [e]) {
    ...
    if (s !== null && (i === null || s !== i)) {
      ...
      if (n === void 0) {
        ...
        n = as($, r), n.setConnected(!1), this.et.set(s, n);
      }
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const rs = "important", Bs = " !" + rs, k = We(class extends Ke {
  constructor(t) {
    var e;
...
const e1 = (t, e, s) => {
  ...
  update(t, [e, s, i]) {
    ...
    let l, p, h = 0, _ = o.length - 1, u = 0, d = n.length - 1;
    for (; h <= _ && u <= d; ) if (o[h] === null) h++;
    else if (o[_] === null) _--;
    else if (a[h] === r[u]) c[u] = ge(o[h], n[u]), h++, u++;
    else if (a[_] === r[d]) c[d] = ge(o[_], n[d]), _--, d--;
    else if (a[h] === r[d]) c[d] = ge(o[h], n[d]), Ce(t, c[d + 1], o[h]), h++, d--;
    else if (a[_] === r[u]) c[u] = ge(o[_], n[u]), Ce(t, o[h], o[_]), _--, u++;
    else if (l === void 0 && (l = e1(r, u, d), p = e1(a, h, _)), l.has(a[h])) if (l.has(a[_])) {
      const f = p.get(r[u]), C = f !== void 0 ? o[f] : null;
      if (C === null) {
        const y = Ce(t, o[h]);
        ge(y, n[u]), c[u] = y;
      } else c[u] = ge(C, n[u]), Ce(t, o[h], C), o[f] = null;
      u++;
    } else ft(o[_]), _--;
    else ft(o[h]), h++;
    for (; u <= d; ) {
...
const Be = ["sensor"], Ne = ["binary_sensor"], Re = ["cover"], rt = ["climate"], ls = ["camera"], Pe = [
  ...
  const o = t.replace(/\/\*[\s\S]*?\*\//g, "").replace(/\n/g, " ").split(";").map((n) => n.trim()).filter((n) => n && n.includes(":")).reduce((n, r) => {
    ...
    if (c && l !== void 0) {
      const p = c.trim(), h = p.startsWith("--") ? p : p.replace(/-([a-z])/g, (_, u) => u.toUpperCase());
      n[h] = l.trim();
    }
    return n;
  }, {});
...
`, ie = [
  ...
  "not_home",
  "disarmed"
], ko = "unavailable", zo = "unknown", ce = [ko, zo], Do = (t, e, s, i, o) => {
  var h, _, u, d, f;
  ...
  if (n && n !== "default" && ((_ = e == null ? void 0 : e.themes) != null && _[n])) {
    ...
    return;
  const l = ((d = t.__themes) == null ? void 0 : d.keys) || /* @__PURE__ */ new Set(), p = new Set(Object.keys(c));
  ...
  bind(e, s = {}) {
    e.actionHandler && it(s, e.actionHandler.options) || (e.actionHandler && (e.removeEventListener("touchstart", e.actionHandler.start), e.removeEventListener("touchend", e.actionHandler.end), e.removeEventListener("touchcancel", e.actionHandler.end), e.removeEventListener("mousedown", e.actionHandler.start), e.removeEventListener("click", e.actionHandler.end), e.removeEventListener(
      ...
      if (i.currentTarget !== i.target || i.type === "touchcancel" || i.type === "touchend" && this.cancelled)
        return;
      const o = i.target;
      i.cancelable && i.preventDefault(), s.hasHold && (clearTimeout(this.timer), this.timer = void 0), s.hasHold && this.held ? D(o, "action", { action: "hold" }) : s.hasDoubleClick ? i.type === "click" && i.detail < 2 || !this.dblClickTimeout ? this.dblClickTimeout = window.setTimeout(() => {
...
const Wo = () => {
  ...
  D(t, "hass-action", { config: s, action: i });
};
function W1(t) {
  ...
  if (e === "domain") {
    ...
    if (_) {
      ...
      if (s !== "binary_sensor" && s !== "sensor")
        if (s === "climate") {
          const f = (h = (p = t._config) == null ? void 0 : p.customization_domain) == null ? void 0 : h.find(
            (y) => y.type === "climate"
...
const X1 = /* @__PURE__ */ new Set(), en = [ce, ie], Tt = class Tt extends ee {
    ...
    super(...arguments), this._onPopState = (e) => {
      ...
      (e, s, i, o, n, r, a) => {
        const c = new Set(
          ...
          a
        ), p = s == null ? void 0 : s.category_filter, h = (_) => ve(_, e, p);
        return l.filter((_) => {
          if (!h(_)) return !1;
          const u = T(_);
  ...
  _getPopupCardConfig(e) {
    var u, d, f, C, y, w, b, g, v, M, A;
    const s = this.card, i = T(e.entity_id), o = this.selectedDomain || i, n = this.selectedDomain ? this.selectedDeviceClass : (C = (f = (d = (u = this.hass) == null ? void 0 : u.states) == null ? void 0 : d[e.entity_id]) == null ? void 0 : f.attributes) == null ? void 0 : C.device_class, r = (s == null ? void 0 : s._config) || {};
    let a;
  ...
  sortEntitiesForPopup(e) {
    ...
    if (s === "state") {
      ...
      return i.sort((c, l) => {
        ...
        if (p !== h) return p - h;
        const _ = T(c.entity_id), u = T(l.entity_id), d = this.hass ? G1(this.hass, c.state, _) : c.state, f = this.hass ? G1(this.hass, l.state, u) : l.state, C = (d || "").localeCompare(f || "");
  ...
  render() {
    var M, A, H, x, z, B, V, S, Z, I, N, U, re;
    if (!this.open || !this.hass || !this.card) return m``;
    const e = this.card, s = (M = e._config) == null ? void 0 : M.area, i = e._devices && Array.isArray(e._devices) ? e._devices : e.hass && e.hass.devices ? e.hass.devices : {}, o = e.hass && e.hass.devices && e.hass.entities ? he(e.hass.entities, e.hass.devices) : void 0, n = o ? X1 : Fe(s, i), r = this.hass.states, a = ((A = e._config) == null ? void 0 : A.popup_domains) || [];
    (H = e._config) != null && H.hidden_entities;
    const c = ((x = e._config) == null ? void 0 : x.extra_entities) || [];
    (z = e._config) == null || z.label;
    const l = (B = e._config) == null ? void 0 : B.hide_unavailable, p = (V = e._config) == null ? void 0 : V.category_filter, h = this.selectedDomain || null, _ = this.selectedDeviceClass || null, u = (E) => ve(E, this.hass.entities, p);
    let d = [];
    this.entities && this.entities.length > 0 ? d = this.entities.reduce((E, R) => {
      const P = R.entity_id;
      if (!u(P)) return E;
      const se = T(P);
      return a.length > 0 && !a.includes(se) || h && se !== h || E.push(P), E;
    }, []) : d = this._getCandidateEntityIds(
      this.hass.entities,
      e._config,
      s,
      n,
    ...
    for (const E of c) {
      const R = T(E), P = r[E];
      P && (a.length > 0 && !a.includes(R) || h && R !== h || _ && P.attributes.device_class !== _ || u(E) && !f.some((se) => se.entity_id === E) && f.push(P));
    }
    const C = ((S = e == null ? void 0 : e._config) == null ? void 0 : S.ungroup_areas) === !0;
    let y = (Z = e._config) != null && Z.columns ? e._config.columns : 4, w = [], b = [];
    if (C)
      b = this.sortEntitiesForPopup(f), y = Math.min(y, Math.max(1, b.length));
    else {
      const E = {};
      for (const W of f) {
        const J = T(W.entity_id);
        J in E || (E[J] = []), E[J].push(W);
      }
      const R = Object.keys(je || {}), P = a.length > 0 ? a : R;
      w = Object.entries(E).filter(([W]) => !h || W === h).sort(([W], [J]) => {
        const Ee = P.indexOf(W), Se = P.indexOf(J);
        return (Ee === -1 ? P.length : Ee) - (Se === -1 ? P.length : Se);
      }).map(
        ([W, J]) => [W, this.sortEntitiesForPopup(J)]
      );
      const se = w.length ? Math.max(...w.map(([, W]) => W.length)) : 0;
    ...
    if (!(w.length > 0 || b.length > 0))
      ...
      `;
    const v = ((U = e._area) == null ? void 0 : U.call(e, (I = e._config) == null ? void 0 : I.area, (N = e.hass) == null ? void 0 : N.areas)) ?? null;
    return m`
      <ha-dialog
        hideActions
        id="more-info-dialog"
...
let ue = class extends ee {
  ...
  updated(t) {
    ...
    (t.has("hass") && (!e || e.themes !== this.hass.themes) || t.has("_config") && (!s || s.theme !== this._config.theme)) && Do(this, this.hass.themes, this._config.theme);
  }
  shouldUpdate(t) {
    var o, n;
  ...
  _renderCovers(t, e, s) {
    ...
    return m`
      ...
      ({ domain: a, deviceClass: c }) => {
        ...
        }), u = (l == null ? void 0 : l.color) || ((y = this._config) == null ? void 0 : y.cover_color), d = l == null ? void 0 : l.icon, f = _.length;
        return f > 0 ? m`
                  <div
                    class="icon-with-count hover"
                    style=${k(
          this._getParsedCss(
            ((w = l == null ? void 0 : l.styles) == null ? void 0 : w.button) || ((b = l == null ? void 0 : l.styles) == null ? void 0 : b.card) || ((g = this._config) == null ? void 0 : g.cover_css) || ((M = (v = this._config) == null ? void 0 : v.styles) == null ? void 0 : M.cover),
            l
          )
        )}
                    @action=${Yo(this, a, c)}
  ...
  _renderAlerts(t, e, s) {
    ...
    return (r = this._config) != null && r.excluded_entities, m`
      ...
      ({ domain: a, deviceClass: c }) => {
        ...
        }), u = (l == null ? void 0 : l.color) || ((y = this._config) == null ? void 0 : y.alert_color), d = l == null ? void 0 : l.icon, f = _.length;
        return f > 0 ? m`
                  <div
                    class="icon-with-count hover"
                    style=${k(
          this._getParsedCss(
            ((w = l == null ? void 0 : l.styles) == null ? void 0 : w.button) || ((b = l == null ? void 0 : l.styles) == null ? void 0 : b.card) || ((g = this._config) == null ? void 0 : g.alert_css) || ((M = (v = this._config) == null ? void 0 : v.styles) == null ? void 0 : M.alert),
            l
          )
        )}
                    @action=${qo(this, a, c)}
  ...
  renderCustomButtons(t) {
    ...
    return m`
      ...
      var a, c, l, p, h;
      if (n.conditional) {
        const _ = n.entity ? T(n.entity) : null;
        if (_ && _ in t) {
          const u = t[_].find(
            (d) => d.entity_id === n.entity
          );
      ...
      return m`
        ...
        ...this._getParsedCss(
          ...
          n
                  ...
                  ></ha-icon>`}
              ${n.name ? m`<span class="custom-button-label" style=${k({
        ...r,
        ...this._getParsedCss((h = n.styles) == null ? void 0 : h.name, n)
      })}"
                    >${n.name}</span
                  >` : $}
            </div>
  ...
  _renderButtons(t, e, s) {
    ...
    return (r = this._config) != null && r.excluded_entities, m`
      ...
      (a) => a,
      (a) => {
        var b, g, v, M, A, H, x, z, B;
        if (a === "climate") {
          const V = s.get("climate");
          if (V && V.hide === !0)
            return $;
        }
        const c = s.get(a), l = (c == null ? void 0 : c.color) || ((b = this._config) == null ? void 0 : b.domain_color), p = c == null ? void 0 : c.icon, h = a === "climate" ? (v = (g = this._config) == null ? void 0 : g.customization_domain) == null ? void 0 : v.find(
          (V) => V.type === "climate"
        ) : void 0, _ = h == null ? void 0 : h.display_mode, u = h == null ? void 0 : h.show_set_temperature, d = a === "climate" && (_ === "icon" || _ === "text_icon") && u === !0, f = e[a].filter((V) => !(ce.includes(V.state) || this._excludedEntitiesSet.has(V.entity_id)));
        let C = [], y;
        if (d) {
          C = f;
          let V = !1, S = !1;
          for (const Z of f) {
            const I = ((M = Z.attributes) == null ? void 0 : M.hvac_action) ?? null, N = (Z.state ?? "").toString().toLowerCase();
            if (I != null) {
              const U = I.toString().toLowerCase();
              V = V || U.includes("heat") || U.includes("heating"), S = S || U.includes("cool") || U.includes("cooling");
            } else
              V = V || N.includes("heat") || N.includes("heating"), S = S || N.includes("cool") || N.includes("cooling");
            if (V && S) break;
          }
          V ? y = "red" : S && (y = "cornflowerblue");
        } else
          C = f.filter((V) => {
            var S;
            if (a === "climate") {
              const Z = (S = V.attributes) == null ? void 0 : S.hvac_action;
              if (Z != null) {
                const N = Z.toString().toLowerCase();
                return !(N === "off" || N === "idle");
              }
              const I = (V.state ?? "").toString().toLowerCase();
              return !(I === "off" || I === "idle");
            }
            return !ie.includes(V.state);
          });
        const w = C.length;
        return this._config.show_active && w === 0 ? $ : m`
              <div
                class="icon-with-count hover"
                style=${k(
          this._getParsedCss(
            ((A = c == null ? void 0 : c.styles) == null ? void 0 : A.button) || ((H = c == null ? void 0 : c.styles) == null ? void 0 : H.card) || (c == null ? void 0 : c.css) || ((x = this._config) == null ? void 0 : x.domain_css) || ((B = (z = this._config) == null ? void 0 : z.styles) == null ? void 0 : B.domain),
            c
          )
        )}
                @action=${Lt(this, a)}
              ...
              >
                ${(() => {
          var Z, I;
          const V = p || this._cachedIcon(a, w > 0), S = k({
            ...y ? { color: y } : {},
            ...!y && l ? { color: `var(--${l}-color)` } : {},
            ...!y && !l && ((Z = this._config) != null && Z.domain_color) ? { color: this._config.domain_color } : {},
            ...this._getParsedCss(
              ((I = c == null ? void 0 : c.styles) == null ? void 0 : I.icon) || (c == null ? void 0 : c.icon_css),
              c
            )
          });
          return V && !V.startsWith("mdi:") ? V.startsWith("M") ? m`<ha-svg-icon
                        class=${w > 0 ? "toggle-on" : "toggle-off"}
                        style=${S}
                        .path=${V}
                      ></ha-svg-icon>` : m`<ha-icon
                      class=${w > 0 ? "toggle-on" : "toggle-off"}
  ...
  _renderSensors(t, e, s, i, o) {
    ...
    return (n = this._config) != null && n.excluded_entities, m`
      ...
      ({ domain: a, deviceClass: c, index: l }) => {
        var g, v, M, A, H, x, z, B;
        const h = (((g = s.get(a)) == null ? void 0 : g.get(c)) || []).filter(
          (V) => {
            var S;
            return !this._excludedEntitiesSet.has(V.entity_id) && ve(
              V.entity_id,
              this.hass.entities,
              (S = this._config) == null ? void 0 : S.category_filter
            );
          }
        );
        if (h.length === 0)
        ...
        const u = _ ? this.hass.states[_] : void 0, d = o.get(c), f = (d == null ? void 0 : d.color) || ((v = this._config) == null ? void 0 : v.sensor_color), C = (d == null ? void 0 : d.invert) === !0, y = h.some(
          (V) => !ce.includes(V.state) && !ie.includes(V.state)
        );
        if (C && y)
          return $;
        const w = (M = this._config) != null && M.show_sensor_icons ? m`<ha-domain-icon
                      style=${k({
          ...f ? { color: `var(--${f}-color)` } : {},
          ...this._getParsedCss(
            ((A = d == null ? void 0 : d.styles) == null ? void 0 : A.icon) || (d == null ? void 0 : d.css),
            d
          )
        })}
                      .hass=${this.hass}
          ...
          ...f ? { color: `var(--${f}-color)` } : {},
          ...this._getParsedCss(
            ((H = d == null ? void 0 : d.styles) == null ? void 0 : H.button) || ((x = d == null ? void 0 : d.styles) == null ? void 0 : x.card) || (d == null ? void 0 : d.css),
            d
          )
        })}
                >
                  ${!((z = this._config) != null && z.show_sensor_icons) && !((B = this._config) != null && B.wrap_sensor_icons) && l > 0 ? " - " : ""}
        ...
        return m`<div class="sensor-row off">${w}${b}</div>`;
      }
      ...
      ({ domain: n }) => {
        ...
        if ((a == null ? void 0 : a.show_set_temperature) === !0) {
          const y = r.filter((g) => !this._excludedEntitiesSet.has(g.entity_id)).map((g) => {
            var Z, I, N, U, re, E;
            const v = ((Z = g.attributes) == null ? void 0 : Z.temperature) ?? ((I = g.attributes) == null ? void 0 : I.target_temperature) ?? null;
            if (v == null) return null;
            const M = Number(v);
            if (Number.isNaN(M)) return null;
            const A = ((re = (U = (N = this.hass) == null ? void 0 : N.config) == null ? void 0 : U.unit_system) == null ? void 0 : re.temperature) || "", H = ((E = g.attributes) == null ? void 0 : E.hvac_action) ?? null, x = (g.state ?? "").toString().toLowerCase(), z = (H ?? x).toString().toLowerCase(), B = z.includes("heat") || z.includes("heating"), V = z.includes("cool") || z.includes("cooling");
            return m`<span style="color:${B ? "red" : V ? "cornflowerblue" : "var(--secondary-text-color)"};"
                    >${M}${A ? ` ${A}` : ""}</span
                  >`;
          }).filter((g) => g !== null);
        ...
        const l = (r || []).filter((y) => {
          var A;
          const w = (A = y.attributes) == null ? void 0 : A.hvac_action, b = y.state, g = !ce.includes(b) && !ie.includes(b) && !i.includes(y.entity_id);
          if (w != null) {
            const H = w.toString().toLowerCase();
            return g && (H !== "idle" && H !== "off");
          }
          const v = (b ?? "").toString().toLowerCase(), M = v.includes("heat") || v.includes("cool") || v !== "idle" && v !== "off";
          return g && M;
        }).map((y) => {
          var b, g, v, M;
          return `${((b = y.attributes) == null ? void 0 : b.temperature) ?? "N/A"} ${((M = (v = (g = this.hass) == null ? void 0 : g.config) == null ? void 0 : v.unit_system) == null ? void 0 : M.temperature) || ""}`;
        });
        if (l.length === 0)
          return $;
        const p = a == null ? void 0 : a.color, h = {
          ...p ? { color: `var(--${p}-color)` } : {},
          ...!p && ((d = this._config) != null && d.domain_color) ? { color: this._config.domain_color } : {},
          ...this._getParsedCss(
  ...
  _renderBottom(t, e, s, i, o, n, r, a) {
    ...
    return m`
      ...
      ...this._getParsedCss(
        ((p = (l = this._config) == null ? void 0 : l.styles) == null ? void 0 : p.name) || ((h = this._config) == null ? void 0 : h.name_css),
        this._config
      )
    })}
  ...
  render() {
    var S, Z, I, N, U, re, E, R, P, se, W, J, Ee, Se, Zt, It;
    if (!this._config || !this.hass || !this.hass.areas || !this.hass.devices || !this.hass.entities)
      return $;
    const t = ((S = this._config) == null ? void 0 : S.design) === "V2", e = t && ((Z = this._config) != null && Z.v2_color) ? `rgba(${this._config.v2_color.join(", ")})` : "var(--primary-color)", s = {
    ...
    const _ = this._area(this._config.area, ((re = this.hass) == null ? void 0 : re.areas) || {}), u = this._customizationDomainMap, d = this._customizationCoverMap, f = this._customizationAlertMap, C = this._customizationSensorMap, y = this._computeCovers(h, this._deviceClasses), w = this._computeAlerts(h, this._deviceClasses), b = this._computeButtons(
      this._config.toggle_domains,
      h
    ), g = this._computeSensors(h, this._deviceClasses), v = ((R = (E = this._config) == null ? void 0 : E.toggle_domains) != null && R.includes("climate") ? rt : []).filter((G) => G in h).map((G) => ({ domain: G })), M = (((P = this._config) == null ? void 0 : P.display_type) || "").toString().toLowerCase(), A = M.includes("camera"), H = M.includes("picture") || M.includes("image"), x = M === "" ? !0 : M.includes("icon"), z = this._computeCameraEntity(
      A,
      h
    );
    if (_ === null)
    ...
    ), V = this.layout === "grid" || this.layout === "panel";
    return m`
      <ha-card
        class="${Q(s)}"
        style=${k(
      ...
      >
        <div
          class="header"
          style=${(H || A) && (z || _.picture) ? "padding-bottom:0em" : "padding-bottom:12em"}
          @action=${this._handleAction}
          .actionHandler=${q(this._config)}
        >
          <div
            class="picture"
            style=${V ? $ : "max-height:12em;"}
          >
            ${(() => {
      var G, fe, qe, Oe;
      if ((H || A) && (z || _.picture))
...
class be extends ee {
  ...
  _valueChanged(e) {
    ...
    o[i] = { ...o[i], type: s || "" }, D(this, "config-changed", o);
  }
  _removeRow(e) {
    e.stopPropagation();
    ...
    if (s != null) {
      ...
      i.splice(s, 1), D(this, "config-changed", i);
    }
  }
  _editRow(e) {
    e.stopPropagation();
    const s = e.target.index;
    s != null && D(this, "edit-item", s);
  }
  _addRow(e) {
    ...
    D(this, "config-changed", [...this.customization, o]), s.value = "";
  }
  static get styles() {
    return we`
      .customization {
...
let Ue = class extends ee {
  ...
  _removeRow(t) {
    ...
    s.splice(e, 1), D(this, "config-changed", s);
  }
  _addRow() {
    const t = {
      name: "",
      ...
      ${this._activeTab === "style" ? m`
            <ha-alert alert-type="info" title="Style Guide">
              ...
              <ul>
                ...
                ${this.getSchema === "custom_button" ? m`<li><b>name</b>: Item Name (Label)</li>` : $}
              </ul>
              <p>
...
let K = class extends ee {
  ...
  _classesForArea(t, e, s, i, o) {
    ...
    if (e === "toggle") {
      const u = l.filter(
        (d) => Pe.includes(T(d.entity_id)) || rt.includes(T(d.entity_id))
      );
      return [...new Set(u.map((d) => T(d.entity_id)))];
    }
    if (e === "all") {
      const u = c.map((f) => this.hass.states[f]).filter((f) => f !== void 0), d = [...l, ...u];
      return [...new Set(d.map((f) => T(f.entity_id)))];
    }
    const h = l.filter(
      (u) => {
        var d;
        return T(u.entity_id) === e && !((d = i[u.entity_id]) != null && d.entity_category);
      }
      ...
      if (t.has("_config")) {
        ...
        if (i !== void 0 && i !== o) {
          const h = this._toggleDomainsForArea(
            ...
            const v = y.has(b) ? y.get(b) : Number.MAX_SAFE_INTEGER, M = y.has(g) ? y.get(g) : Number.MAX_SAFE_INTEGER;
            return v === M ? b.localeCompare(g) : v - M;
          });
          if (this._config.toggle_domains = [
            ...f.filter((b) => b !== "scene" && b !== "script")
          ], this._config.alert_classes = [..._], this._config.cover_classes = [...u], this._config.popup_domains = [...w], this._config.customization_domain = [], this._config.customization_alert = [], this._config.customization_cover = [], this._config.customization_sensor = [], this._updateEntityOptions(), Array.isArray(this._config.hidden_entities)) {
            const b = this._config.hidden_entities, g = Object.values(this._hiddenEntitiesByDomain()).flat(), v = b.filter((M) => g.includes(M));
  ...
  _updateEntityOptions() {
    ...
    this._entityOptions = i.filter((n) => {
      var a;
      return this.hass.states[n] ? !((a = this.hass.entities[n]) != null && a.hidden) && e.includes(T(n)) : !1;
    }).map((n) => ({
      value: n,
      label: n
    }));
  ...
  _customizationChanged(t, e) {
    t.stopPropagation(), !(!this._config || !this.hass) && D(this, "config-changed", {
      config: {
        ...this._config,
  ...
  _itemChangedCustomButton(t) {
    ...
    if (e !== void 0) {
      ...
      i[e] = t.detail, D(this, "config-changed", {
  ...
  _renderSubElementEditor(t, e, s) {
    var p, h, _;
    const i = `customization_${t}`, o = (p = this._config) == null ? void 0 : p[i], n = `_subElementEditor${t.charAt(0).toUpperCase() + t.slice(1)}`, r = ((h = this[n]) == null ? void 0 : h.index) ?? 0, a = ((_ = o == null ? void 0 : o[r]) == null ? void 0 : _.type) ?? "unknown", c = a.match(/^(.+?)\s*-\s*(.+)$/);
    let l;
    if (c) {
      const u = c[1].toLowerCase().replace(" ", "_"), d = c[2].toLowerCase(), f = this.hass.localize(`component.${u}.entity_component._.name`) || c[1];
      let C = this.hass.localize(
        `ui.dialogs.entity_registry.editor.device_classes.${u}.${d}`
      ) || c[2];
  ...
  _itemChanged(t, e, s) {
    ...
    if (i != null) {
      ...
      o[i] = t.detail, D(this, "config-changed", {
  ...
  _hiddenEntitiesByDomain() {
    ...
    const s = ((_ = this.hass) == null ? void 0 : _.entities) || {}, i = ((u = this.hass) == null ? void 0 : u.devices) || {}, o = (d = this.hass) != null && d.areas ? Object.values(this.hass.areas) : [], n = (f = this._config) == null ? void 0 : f.area, r = (C = this._config) == null ? void 0 : C.floor, a = (y = this._config) == null ? void 0 : y.label, c = n ? Array.isArray(n) ? n : [n] : [], l = r ? Array.isArray(r) ? r : [r] : [], p = a ? Array.isArray(a) ? a : [a] : [];
    for (const w of e) {
      const b = T(w), g = s[w], v = g != null && g.device_id ? i[g.device_id] : void 0;
                ...
                <ha-expansion-panel outlined class="main">
                  ...
                  <div class="content">
                    <ha-form
                      .hass=${this.hass}
                      .data=${{
      category_filter: (h = this._config) == null ? void 0 : h.category_filter
    }}
                      .schema=${[
      {
      ...
      (_) => m`
            ...
            return m`
                                            <div class="entity-row">
                                              <span class="entity-name">
                                                ${((C = (f = this.hass.states[d]) == null ? void 0 : f.attributes) == null ? void 0 : C.friendly_name) || d}
                                              </span>
                                              <ha-icon-button
                                                .path=${this._isHiddenEntity(d) ? mt : C1}
        ...
        (u) => {
          ...
          return m`
                                    <div class="entity-row">
                                      <span class="entity-name">
                                        ${((f = (d = this.hass.states[u]) == null ? void 0 : d.attributes) == null ? void 0 : f.friendly_name) || u}
                                      </span>
                                      <ha-icon-button
