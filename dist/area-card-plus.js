 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: mi, defineProperty: _i, getOwnPropertyDescriptor: pi, getOwnPropertyNames: fi, getOwnPropertySymbols: gi, getPrototypeOf: vi } = Object, le = globalThis, At = le.trustedTypes, yi = At ? At.emptyScript : "", Qe = le.reactiveElementPolyfillSupport, ze = (t, e) => t, Ge = { toAttribute(t, e) {
  switch (e) {
    case Boolean:
      t = t ? yi : null;
      break;
...
$e.elementStyles = [], $e.shadowRootOptions = { mode: "open" }, $e[ze("elementProperties")] = /* @__PURE__ */ new Map(), $e[ze("finalized")] = /* @__PURE__ */ new Map(), Qe == null || Qe({ ReactiveElement: $e }), (le.reactiveElementVersions ?? (le.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const He = globalThis, Ze = He.trustedTypes, St = Ze ? Ze.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, Wt = "$lit$", ce = `lit$${Math.random().toFixed(9).slice(2)}$`, Gt = "?" + ce, bi = `<${Gt}>`, ge = document, Pe = () => ge.createComment(""), Be = (t) => t === null || typeof t != "object" && typeof t != "function", ft = Array.isArray, $i = (t) => ft(t) || typeof (t == null ? void 0 : t[Symbol.iterator]) == "function", et = `[ 	
\f\r]`, De = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Ot = /-->/g, kt = />/g, me = RegExp(`>|${et}(?:([^\\s"'>=/]+)(${et}*=${et}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Dt = /'/g, Lt = /"/g, Zt = /^(?:script|style|textarea|title)$/i, wi = (t) => (e, ...i) => ({ _$litType$: t, strings: e, values: i }), w = wi(1), X = Symbol.for("lit-noChange"), x = Symbol.for("lit-nothing"), zt = /* @__PURE__ */ new WeakMap(), pe = ge.createTreeWalker(ge, 129);
function Xt(t, e) {
...
const Ci = (t, e) => {
  ...
  for (let r = 0; r < i; r++) {
    ...
    n += a === De ? c + bi : u >= 0 ? (s.push(d), c.slice(0, u) + Wt + c.slice(u) + ce + h) : c + ce + (u === -2 ? r : h);
  }
...
class Te {
  constructor({ strings: e, _$litType$: i }, s) {
    ...
    if (this.el = Te.createElement(d, s), pe.currentNode = this.el.content, i === 2 || i === 3) {
    ...
    for (; (o = pe.nextNode()) !== null && c.length < r; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const u of o.getAttributeNames()) if (u.endsWith(Wt)) {
          const m = l[a++], h = o.getAttribute(u).split(ce), _ = /([.?@])?(.*)/.exec(m);
          c.push({ type: 1, index: n, name: _[2], strings: h, ctor: _[1] === "." ? Ai : _[1] === "?" ? Ei : _[1] === "@" ? Si : Xe }), o.removeAttribute(u);
        } else u.startsWith(ce) && (c.push({ type: 6, index: n }), o.removeAttribute(u));
        if (Zt.test(o.tagName)) {
          const u = o.textContent.split(ce), m = u.length - 1;
          if (m > 0) {
        ...
        let u = -1;
        for (; (u = o.data.indexOf(ce, u + 1)) !== -1; ) c.push({ type: 7, index: n }), u += ce.length - 1;
      }
      n++;
    }
  }
...
class Ae {
  ...
  _$AI(e, i = this) {
    e = Ce(this, e, i), Be(e) ? e === x || e == null || e === "" ? (this._$AH !== x && this._$AR(), this._$AH = x) : e !== this._$AH && e !== X && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : $i(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== x && Be(this._$AH) ? this._$AA.nextSibling.data = e : this.T(ge.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var n;
    const { values: i, _$litType$: s } = e, o = typeof s == "number" ? this._$AC(e) : (s.el === void 0 && (s.el = Te.createElement(Xt(s.h, s.h[0]), this.options)), s);
  ...
  _$AC(e) {
    ...
    return i === void 0 && zt.set(e.strings, i = new Te(e)), i;
  }
  k(e) {
...
class Xe {
  ...
  _$AI(e, i = this, s, o) {
    ...
    let a = !1;
    if (n === void 0) e = Ce(this, e, i, 0), a = !Be(e) || e !== this._$AH && e !== X, a && (this._$AH = e);
    else {
      const r = e;
      let c, d;
      for (e = n[0], c = 0; c < n.length - 1; c++) d = Ce(this, r[s + c], i, c), d === X && (d = this._$AH[c]), a || (a = !Be(d) || d !== this._$AH[c]), d === x ? e = x : e !== x && (e += (d ?? "") + n[c + 1]), this._$AH[c] = d;
    }
    a && !o && this.j(e);
  }
  j(e) {
...
tt == null || tt(Te, Ae), (He.litHtmlVersions ?? (He.litHtmlVersions = [])).push("3.3.1");
const Di = (t, e, i) => {
...
var qt;
Z._$litElement$ = !0, Z.finalized = !0, (qt = fe.litElementHydrateSupport) == null || qt.call(fe, { LitElement: Z });
...
const { I: Mi } = ki, Ht = () => document.createComment(""), Le = (t, e, i) => {
  ...
  return i;
}, _e = (t, e, i = t) => (t._$AI(e, i), t), Pi = {}, Bi = (t, e = Pi) => t._$AH = e, Ti = (t) => t._$AH, st = (t) => {
...
const Mt = (t, e, i) => {
  ...
  update(t, [e, i, s]) {
    ...
    else if (r[u] === a[_]) c[_] = _e(o[u], n[_]), Le(t, c[_ + 1], o[u]), u++, _--;
    else if (r[m] === a[h]) c[h] = _e(o[m], n[h]), Le(t, o[u], o[m]), m--, h++;
    else if (d === void 0 && (d = Mt(a, h, _), l = Mt(r, u, m)), d.has(r[u])) if (d.has(r[m])) {
      const v = l.get(a[h]), p = v !== void 0 ? o[v] : null;
      if (p === null) {
        const b = Le(t, o[u]);
        _e(b, n[h]), c[h] = b;
      } else c[h] = _e(p, n[h]), Le(t, o[u], p), o[v] = null;
      h++;
    } else st(o[m]), m--;
    else st(o[u]), u++;
    for (; h <= _; ) {
...
const Ve = ["sensor"], qe = ["binary_sensor"], Ke = ["cover"], at = ["climate"], Ri = ["camera"], Me = [
  ...
  if (n && n !== "default" && ((m = e == null ? void 0 : e.themes) != null && m[n])) {
    ...
    c = { ...c, ...b }, p && (a && p.dark ? c = { ...c, ...p.dark } : !a && p.light && (c = { ...c, ...p.light }));
  } else if (!n && (!((h = t.__themes) != null && h.keys) || t.__themes.keys.size === 0))
    return;
  const d = ((_ = t.__themes) == null ? void 0 : _.keys) || /* @__PURE__ */ new Set(), l = new Set(Object.keys(c));
...
const ji = (t, e = 2) => Math.round(t * 10 ** e) / 10 ** e, Fi = (t) => Vi(t.attributes), Vi = (t) => !!t.unit_of_measurement || !!t.state_class, qi = (t) => {
  ...
  const d = () => {
    ...
    s && (a = s(t, c)), i && (t.addEventListener("ready", l), l()), t.addEventListener("disconnected", _);
  }, m = () => {
    r = void 0, a && a.then((v) => {
      v();
    }), c.clearState(), t.removeEventListener("ready", d), t.removeEventListener("disconnected", _);
  }, h = () => {
    r = setTimeout(m, Yi);
  }, _ = () => {
    r && (clearTimeout(r), m());
...
const ds = () => {
  ...
  M(t, "hass-action", { config: i, action: s });
};
function H(t) {
...
var vs = Object.defineProperty, de = (t, e, i, s) => {
  for (var o = void 0, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (o = a(e, i, o) || o);
  return o && vs(e, i, o), o;
};
const ri = [ei, ti], ys = [ri, Q], $t = class $t extends Z {
  constructor() {
  ...
  _getPopupCardConfig(e) {
    var h, _, v, p, b, y, g, f, $, S, C;
    const i = this.card, s = T(e.entity_id), o = this.selectedDomain || s, n = this.selectedDomain ? this.selectedDeviceClass : (p = (v = (_ = (h = this.hass) == null ? void 0 : h.states) == null ? void 0 : _[e.entity_id]) == null ? void 0 : v.attributes) == null ? void 0 : p.device_class, a = (i == null ? void 0 : i._config) || {};
    let r;
    qe.includes(o) ? (r = (b = a.customization_alert) == null ? void 0 : b.find(
      (E) => E.type === n
    ), r || (r = (y = a.customization_domain) == null ? void 0 : y.find(
      (E) => E.type === o
    ))) : Ve.includes(o) ? (r = (g = a.customization_sensor) == null ? void 0 : g.find(
      (E) => E.type === n
    ), r || (r = (f = a.customization_domain) == null ? void 0 : f.find(
      (E) => E.type === o
    ))) : Ke.includes(o) ? (r = ($ = a.customization_cover) == null ? void 0 : $.find(
      (E) => E.type === n
  ...
  sortEntitiesForPopup(e) {
    ...
    if (i === "state") {
      ...
      return s.sort((c, d) => {
        ...
        if (l !== u) return l - u;
        const m = T(c.entity_id), h = T(d.entity_id), _ = this.hass ? Ft(this.hass, c.state, m) : c.state, v = this.hass ? Ft(this.hass, d.state, h) : d.state, p = (_ || "").localeCompare(v || "");
        return p !== 0 ? p : r(c.entity_id, d.entity_id);
      });
    }
  ...
  render() {
    var S, C, E, B, V, ie, he, se, oe, ne, ae, q, Se;
    if (!this.open || !this.hass || !this.card) return w``;
    const e = this.card, i = (S = e._config) == null ? void 0 : S.area, s = ((C = e._devicesInArea) == null ? void 0 : C.call(e, i, e._devices)) ?? /* @__PURE__ */ new Set(), o = e._entities || [], n = this.hass.states, a = ((E = e._config) == null ? void 0 : E.popup_domains) || [], r = ((B = e._config) == null ? void 0 : B.hidden_entities) || [], c = ((V = e._config) == null ? void 0 : V.extra_entities) || [], d = (ie = e._config) == null ? void 0 : ie.label, l = (he = e._config) == null ? void 0 : he.hide_unavailable, u = (se = e._config) == null ? void 0 : se.category_filter, m = this.selectedDomain || null, h = this.selectedDeviceClass || null, _ = (O) => {
      if (!u) return !0;
      const D = o.find(
        (N) => N.entity_id === O
      ), k = D == null ? void 0 : D.entity_category;
      return k ? u === "config" ? k !== "config" : u === "diagnostic" ? k !== "diagnostic" : u === "config+diagnostic" ? k !== "config" && k !== "diagnostic" : !0 : !0;
    }, v = o.reduce(
      (O, D) => {
        var k;
        if (!D.hidden_by && (D.area_id ? D.area_id === i : D.device_id && s.has(D.device_id)) && (!d || D.labels && D.labels.some(
          ...
          const N = D.entity_id;
          !r.includes(N) && _(N) && (!l || !ri.includes((k = n[N]) == null ? void 0 : k.state)) && O.push(N);
        }
        return O;
      },
      []
    ...
    for (const O of v) {
      ...
      const k = n[O];
      k && (m && D !== m || h && k.attributes.device_class !== h || p.push(k));
    }
    for (const O of c) {
      const D = T(O), k = n[O];
      k && (a.length > 0 && !a.includes(D) || m && D !== m || h && k.attributes.device_class !== h || _(O) && !p.some((N) => N.entity_id === O) && p.push(k));
    }
    const b = ((oe = e == null ? void 0 : e._config) == null ? void 0 : oe.ungroup_areas) === !0;
    let y = (ne = e._config) != null && ne.columns ? e._config.columns : 4, g = [], f = [];
    if (b)
      f = this.sortEntitiesForPopup(p), y = Math.min(y, Math.max(1, f.length));
    else {
      const O = {};
      for (const R of p) {
        const K = T(R.entity_id);
        K in O || (O[K] = []), O[K].push(R);
      }
      const D = Object.keys(Ne || {}), k = a.length > 0 ? a : D;
      g = Object.entries(O).filter(([R]) => !m || R === m).sort(([R], [K]) => {
        const Oe = k.indexOf(R), ke = k.indexOf(K);
        return (Oe === -1 ? k.length : Oe) - (ke === -1 ? k.length : ke);
      }).map(
        ([R, K]) => [R, this.sortEntitiesForPopup(K)]
      );
      const N = g.length ? Math.max(...g.map(([, R]) => R.length)) : 0;
      y = Math.min(y, Math.max(1, N));
    }
    const $ = ((q = e._area) == null ? void 0 : q.call(e, (ae = e._config) == null ? void 0 : ae.area, e._areas)) ?? null;
    return w`
      <ha-dialog
        hideActions
        id="more-info-dialog"
      ...
      >
        <div class="dialog-header">
          ...
          ></ha-icon-button>
          <div slot="title">
            <h3>${((Se = e._config) == null ? void 0 : Se.area_name) || $ && $.name}</h3>
          </div>
        </div>
...
var bs = Object.defineProperty, $s = Object.getOwnPropertyDescriptor, J = (t, e, i, s) => {
  for (var o = s > 1 ? void 0 : s ? $s(e, i) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (o = (s ? a(e, i, o) : a(o)) || o);
  return s && o && bs(e, i, o), o;
};
const be = [ei, ti], ws = "16:5";
let F = class extends cs(Z) {
  constructor() {
    super(...arguments), this.selectedDomain = null, this.selectedDeviceClass = null, this.selectedGroup = null, this.layout = "grid", this._iconCache = /* @__PURE__ */ new Map(), this._styleCache = /* @__PURE__ */ new Map(), this._ratio = null, this._deviceClasses = rt, this._entitiesByDomain = A(
      (t, e, i, s, o) => {
        var c;
...
`).reduce((n, a) => {
  ...
  _openGeneralPopup() {
    ...
    Object.values(i || {}).forEach((r) => {
      r.forEach((c) => {
        !be.includes(c.state) && !Q.includes(c.state) && s.push(c);
      });
    }), this.showPopup(this, "area-card-plus-popup", {
      title: e,
      hass: this.hass,
  ...
  _isOn(t, e) {
    ...
    if (i)
      return (e ? i.filter(
        ...
        (s) => !be.includes(s.state) && !Q.includes(s.state)
      );
  }
  _average(t, e) {
    var r;
    ...
    })}${o ? Nt(o, this.hass.locale) : ""}${o || ""}` : `${Bt(a / n.length, this.hass.locale, {
      maximumFractionDigits: 1
  ...
  _makeActionHandler(t, e, i, s) {
    return (o) => {
      ...
      if (t === "domain") {
        ...
        ot(this, this.hass, $, o.detail.action);
        return;
      }
    ...
    return w`
      ...
      ({ domain: c, deviceClass: d }) => {
        ...
        const l = i.get(d), u = (l == null ? void 0 : l.invert) === !0, m = e[c].filter((y) => {
          const g = y.attributes.device_class || "default", f = y.state === "open";
          return g === d && (u ? Q.includes(y.state) : f) && !s.includes(y.entity_id) && this._filterByCategory(y.entity_id);
        }), h = (l == null ? void 0 : l.color) || ((p = this._config) == null ? void 0 : p.cover_color), _ = l == null ? void 0 : l.icon, v = m.length;
        return v > 0 ? w`
                  <div
...
`).reduce((y, g) => {
          const f = g.trim();
          return f && f.includes(":") && (y += f.endsWith(";") ? f : `${f};`, y += " "), y;
        }, "") : "")}"
  ...
  _renderAlerts(t, e, i) {
    ...
    return w`
      ...
      ({ domain: c, deviceClass: d }) => {
        var p, b;
        const l = i.get(d), u = (l == null ? void 0 : l.invert) === !0, m = e[c].filter((y) => {
          const g = y.attributes.device_class || "default", f = y.state === "on";
          return g === d && (u ? Q.includes(y.state) : f) && !o.includes(y.entity_id) && this._filterByCategory(y.entity_id);
        }), h = (l == null ? void 0 : l.color) || ((p = this._config) == null ? void 0 : p.alert_color), _ = l == null ? void 0 : l.icon, v = m.length;
        return v > 0 ? w`
                  <div
                    class="icon-with-count hover"
                    style=${this._parseCss(
...
`).reduce((y, g) => {
  ...
  _renderButtons(t, e, i) {
    ...
    return w`
      ...
      (c) => {
        var _, v, p, b, y;
        if (c === "climate") {
          const g = (v = (_ = this._config) == null ? void 0 : _.customization_domain) == null ? void 0 : v.find(
            ($) => $.type === "climate"
          ), f = g == null ? void 0 : g.display_mode;
          if (f !== "icon" && f !== "text_icon")
            return x;
        }
        const d = i.get(c), l = (d == null ? void 0 : d.color) || ((p = this._config) == null ? void 0 : p.domain_color), u = d == null ? void 0 : d.icon, h = e[c].filter((g) => {
          var f;
          if (be.includes(g.state) || o.includes(g.entity_id) || !this._filterByCategory(g.entity_id)) return !1;
          if (c === "climate") {
            const $ = (f = g.attributes) == null ? void 0 : f.hvac_action;
            if ($ != null) {
              const C = $.toString().toLowerCase();
              return !(C === "off" || C === "idle");
            }
            const S = (g.state ?? "").toString().toLowerCase();
            return !(S === "off" || S === "idle");
          }
          return !Q.includes(g.state);
        }).length;
        return this._config.show_active && h === 0 ? x : w`
              <div
                class="icon-with-count hover"
                style=${this._parseCss(
  ...
  _renderSensors(t, e, i, s) {
    ...
    return w`
      <div class="sensors">
        ${(a = this._config) != null && a.wrap_sensor_icons ? ee(
      t,
      ...
      ({ domain: r, deviceClass: c, index: d }) => {
        ...
        })(), m = u ? this.hass.states[u] : void 0, h = s.get(c), _ = (h == null ? void 0 : h.color) || ((g = this._config) == null ? void 0 : g.sensor_color), v = (h == null ? void 0 : h.invert) === !0, p = l.some(
          (C) => !be.includes(C.state) && !Q.includes(C.state) && !o.includes(C.entity_id) && this._filterByCategory(C.entity_id)
        );
        if (v && p)
          return x;
        const b = (f = this._config) != null && f.show_sensor_icons ? w`<ha-domain-icon
                      style=${_ ? `color: var(--${_}-color);` : ""}
                      .hass=${this.hass}
                      .domain=${r}
                      .deviceClass=${c}
                    ></ha-domain-icon>` : null, y = w`<span
                  class="sensor-value"
                  @action=${this._handleSensorAction(r, c)}
                  .actionHandler=${G({
          hasHold: H(h == null ? void 0 : h.hold_action),
          hasDoubleClick: H(h == null ? void 0 : h.double_tap_action)
        })}
                  style=${`${_ ? `color: var(--${_}-color);` : ""} ${this._parseCss(h == null ? void 0 : h.css)}`}
                >
                  ${!(($ = this._config) != null && $.show_sensor_icons) && !((S = this._config) != null && S.wrap_sensor_icons) && d > 0 ? " - " : ""}
                  ${m ? this.hass.formatEntityState(m) : this._average(r, c)}
                </span>`;
        return w`<div class="sensor-row off">${b}${y}</div>`;
      }
      ...
      ({ domain: r, deviceClass: c, index: d }) => {
        ...
        const u = (() => {
          ...
          (C) => !be.includes(C.state) && !Q.includes(C.state) && !o.includes(C.entity_id)
        );
        if (v && p)
          return x;
        const b = (f = this._config) != null && f.show_sensor_icons ? w`<ha-domain-icon
    ...
    <div class="climate text-small off">
      ...
      ({ domain: n }) => {
        ...
        if ((r == null ? void 0 : r.show_set_temperature) === !0) {
          const _ = a.filter((y) => !(s.includes(y.entity_id) || !this._filterByCategory(y.entity_id))).map((y) => {
            var ie, he, se, oe, ne, ae;
            const g = ((ie = y.attributes) == null ? void 0 : ie.temperature) ?? ((he = y.attributes) == null ? void 0 : he.target_temperature) ?? null;
            if (g == null) return null;
            const f = Number(g);
            if (Number.isNaN(f)) return null;
            const $ = ((ne = (oe = (se = this.hass) == null ? void 0 : se.config) == null ? void 0 : oe.unit_system) == null ? void 0 : ne.temperature) || "", S = ((ae = y.attributes) == null ? void 0 : ae.hvac_action) ?? null, C = (y.state ?? "").toString().toLowerCase();
            let E = !1, B = !1;
            if (S != null) {
              const q = S.toString().toLowerCase();
              E = q.includes("heat") || q.includes("heating"), B = q.includes("cool") || q.includes("cooling");
            } else
              E = C.includes("heat") || C.includes("heating"), B = C.includes("cool") || C.includes("cooling");
            let V = "color: var(--secondary-text-color);";
            return E ? V = "color: red;" : B && (V = "color: cornflowerblue;"), w`<span style="${V}">${f}${$ ? ` ${$}` : ""}</span>`;
          }).filter((y) => y !== null);
          if (_.length === 0) return x;
          const v = _.flatMap(
            (y, g) => g === 0 ? [y] : [w`, `, y]
          ), p = r == null ? void 0 : r.color, b = `${p ? `color: var(--${p}-color);` : (m = this._config) != null && m.domain_color ? `color: ${this._config.domain_color};` : ""} ${this._parseCss(r == null ? void 0 : r.css)}`;
          return w`<div
              class="climate"
              style=${b}
              @action=${this._handleDomainAction(n)}
              .actionHandler=${G({
            hasHold: H(r == null ? void 0 : r.hold_action),
            hasDoubleClick: H(r == null ? void 0 : r.double_tap_action)
          })}
            >
              (${v})
            </div>`;
        ...
        const d = (a || []).filter((_) => {
          var f;
          const v = (f = _.attributes) == null ? void 0 : f.hvac_action, p = _.state, b = !be.includes(p) && !Q.includes(p) && !s.includes(_.entity_id) && this._filterByCategory(_.entity_id);
          if (v != null) {
            const $ = v.toString().toLowerCase();
            return b && ($ !== "idle" && $ !== "off");
          }
          const y = (p ?? "").toString().toLowerCase(), g = y.includes("heat") || y.includes("cool") || y !== "idle" && y !== "off";
          return b && g;
        }).map((_) => {
          var p, b, y, g;
          return `${((p = _.attributes) == null ? void 0 : p.temperature) ?? "N/A"} ${((g = (y = (b = this.hass) == null ? void 0 : b.config) == null ? void 0 : y.unit_system) == null ? void 0 : g.temperature) || ""}`;
        });
        if (d.length === 0)
          return x;
        const l = r == null ? void 0 : r.color, u = `${l ? `color: var(--${l}-color);` : (h = this._config) != null && h.domain_color ? `color: ${this._config.domain_color};` : ""} ${this._parseCss(r == null ? void 0 : r.css)}`;
        return w`<div
            class="climate"
            style=${u}
            @action=${this._handleDomainAction(n)}
...
`).reduce((d, l) => {
  ...
  render() {
    var se, oe, ne, ae, q, Se, O, D, k, N, R, K, Oe, ke, wt;
    if (!this._config || !this.hass || !this._areas || !this._devices || !this._entities)
      return x;
    const t = ((se = this._config) == null ? void 0 : se.design) === "V2", e = t && ((oe = this._config) != null && oe.v2_color) ? this._calculateV2Color(this._config.v2_color) : "var(--primary-color)", i = {
      mirrored: this._config.mirrored === !0
    }, s = {
      v2: ((ne = this._config) == null ? void 0 : ne.design) === "V2",
      row: ((ae = this._config) == null ? void 0 : ae.layout) === "horizontal"
    };
    let o = 3;
    try {
      const z = ((q = this.shadowRoot) == null ? void 0 : q.host) || document.documentElement, re = getComputedStyle(z).getPropertyValue("--row-size");
      re && (o = Number(re.trim()) || 3);
    } catch {
    }
    ...
    (((D = this._config) == null ? void 0 : D.customization_cover) || []).forEach(
      (z) => v.set(z.type, z)
    );
    const p = /* @__PURE__ */ new Map();
    (((k = this._config) == null ? void 0 : k.customization_alert) || []).forEach(
      (z) => p.set(z.type, z)
    );
    const b = /* @__PURE__ */ new Map();
    (((N = this._config) == null ? void 0 : N.customization_sensor) || []).forEach(
      (z) => b.set(z.type, z)
    );
    const y = this._computeCovers(m, this._deviceClasses), g = this._computeAlerts(m, this._deviceClasses), f = this._computeButtons(
      this._config.toggle_domains,
      m
    ), $ = this._computeSensors(m, this._deviceClasses), S = ((K = (R = this._config) == null ? void 0 : R.toggle_domains) != null && K.includes("climate") ? at : []).filter((z) => z in m).map((z) => ({ domain: z })), C = (((Oe = this._config) == null ? void 0 : Oe.display_type) || "").toString().toLowerCase(), E = C.includes("camera"), B = C.includes("picture") || C.includes("image"), V = C === "" ? !0 : C.includes("icon"), ie = this._computeCameraEntity(
      E,
      m
    );
    if (h === null)
      ...
      `;
    const he = this._computeIconStyles(
      t,
      o,
...
class ye extends Z {
  ...
  _addRow(e) {
    ...
    M(this, "config-changed", [...this.customization, o]), i.value = "";
  }
  static get styles() {
    return xe`
      .customization {
...
let Ie = class extends Z {
  ...
  _removeRow(t) {
    ...
    i.splice(e, 1), M(this, "config-changed", i);
  }
  _addRow() {
    const t = {
      name: "",
...
var Ss = Object.defineProperty, Os = Object.getOwnPropertyDescriptor, Y = (t, e, i, s) => {
...
let U = class extends Z {
  constructor() {
    super(...arguments), this._subElementEditorDomain = void 0, this._subElementEditorAlert = void 0, this._subElementEditorCover = void 0, this._subElementEditorSensor = void 0, this._subElementEditorCustomButton = void 0, this.computeLabel = A((t) => ai(this.hass, t)), this._schema = A(
      (t, e) => {
  ...
  _classesForArea(t, e, i) {
    ...
    if (e === "toggle")
      return s = Object.values(this.hass.entities).filter(
        (n) => {
          var a;
          return (Me.includes(T(n.entity_id)) || at.includes(T(n.entity_id))) && !n.hidden && (n.area_id === t || n.device_id && ((a = this.hass.devices[n.device_id]) == null ? void 0 : a.area_id) === t);
        }
      ), [
    ...
    if (e === "all") {
      ...
      return a = [...a, ...r], [...new Set(a.map((c) => T(c.entity_id)))];
    } else {
      s = Object.values(this.hass.entities).filter(
        (a) => {
          var r;
          return T(a.entity_id) === e && !a.entity_category && !a.hidden && (a.area_id === t || a.device_id && ((r = this.hass.devices[a.device_id]) == null ? void 0 : r.area_id) === t);
        }
      );
      const n = s.map(
        (a) => {
      ...
      if (t.has("_config")) {
        ...
        if (s !== void 0 && s !== o) {
          const u = this._toggleDomainsForArea(o), m = this._binaryClassesForArea(o), h = this._coverClassesForArea(o), _ = this._allDomainsForArea(o), v = u.sort(
            (g, f) => Me.indexOf(g) - Me.indexOf(f)
          ), p = Object.keys(Ne || {}), b = new Map(
            p.map((g, f) => [g, f])
          ), y = _.sort((g, f) => {
            const $ = b.has(g) ? b.get(g) : Number.MAX_SAFE_INTEGER, S = b.has(f) ? b.get(f) : Number.MAX_SAFE_INTEGER;
            return $ === S ? g.localeCompare(f) : $ - S;
          });
          if (this._config.toggle_domains = [
            ...
            const g = this._config.hidden_entities, f = Object.values(this._hiddenEntitiesByDomain()).flat(), $ = g.filter((S) => f.includes(S));
            $.length !== g.length && (this._config = {
              ...this._config || {},
              hidden_entities: $
  ...
  _itemChangedCustomButton(t) {
    ...
    if (e !== void 0) {
      ...
      s[e] = t.detail, M(this, "config-changed", {
  ...
  _renderSubElementEditor(t, e, i) {
    ...
    let d;
    if (c) {
      const h = c[1].toLowerCase().replace(" ", "_"), _ = c[2].toLowerCase(), v = this.hass.localize(`component.${h}.entity_component._.name`) || c[1];
      let p = this.hass.localize(
        `ui.dialogs.entity_registry.editor.device_classes.${h}.${_}`
      ) || c[2];
      p = p.charAt(0).toUpperCase() + p.slice(1), d = `${v} – ${p}`;
    } else {
  ...
  _hiddenEntitiesByDomain() {
    ...
    for (const y of e) {
      const g = T(y), f = i[y], $ = f != null && f.device_id ? s[f.device_id] : void 0;
      if (((f == null ? void 0 : f.area_id) != null || ($ == null ? void 0 : $.area_id) != null) && !(l.length && !(Array.isArray(f == null ? void 0 : f.labels) && f.labels.some((E) => l.includes(E)) || Array.isArray($ == null ? void 0 : $.labels) && $.labels.some((E) => l.includes(E)))) && !(c.length && !(f != null && f.area_id && c.includes(f.area_id) || $ != null && $.area_id && c.includes($.area_id)))) {
        if (d.length) {
          const C = (f == null ? void 0 : f.area_id) && o.some(
            (B) => B.area_id === f.area_id && B.floor_id && d.includes(B.floor_id)
          ), E = ($ == null ? void 0 : $.area_id) && o.some(
            (B) => B.area_id === $.area_id && B.floor_id && d.includes(B.floor_id)
          );
          if (!C && !E) continue;
        }
        t[g] || (t[g] = []), t[g].push(y);
          ...
          (_) => {
            ...
            return w`
                                      <div class="entity-row">
                                        ...
                                        <ha-icon-button
                                          .path=${this._isHiddenEntity(_) ? nt : Rt}
              ...
              "ui.common.hide"
                                        ...
                                        ></ha-icon-button>
                                        <ha-icon-button
                                          .path=${this._isExcludedEntity(_) ? Ut : jt}
        ...
        (h) => {
          ...
          return w`
                              <div class="entity-row">
                                ...
                                ></ha-icon-button>
                                <ha-icon-button
                                  .path=${this._isExcludedEntity(h) ? Ut : jt}
