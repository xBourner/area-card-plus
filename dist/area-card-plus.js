 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Os, defineProperty: ks, getOwnPropertyDescriptor: Ps, getOwnPropertyNames: Ds, getOwnPropertySymbols: zs, getPrototypeOf: Is } = Object, le = globalThis, s1 = le.trustedTypes, Ts = s1 ? s1.emptyScript : "", ct = le.reactiveElementPolyfillSupport, Pe = (t, e) => t, tt = { toAttribute(t, e) {
  switch (e) {
    case Boolean:
      t = t ? Ts : null;
      break;
...
let Ae = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(Pe("properties"))) {
      const s = this.properties, i = [...Ds(s), ...zs(s)];
  ...
  _$AK(e, s) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      ...
      this._$Em = o;
      const h = c.fromAttribute(s, r.type);
...
Ae.elementStyles = [], Ae.shadowRootOptions = { mode: "open" }, Ae[Pe("elementProperties")] = /* @__PURE__ */ new Map(), Ae[Pe("finalized")] = /* @__PURE__ */ new Map(), ct == null || ct({ ReactiveElement: Ae }), (le.reactiveElementVersions ?? (le.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const De = globalThis, st = De.trustedTypes, o1 = st ? st.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, vs = "$lit$", ne = `lit$${Math.random().toFixed(9).slice(2)}$`, Cs = "?" + ne, Zs = `<${Cs}>`, Ce = document, ze = () => Ce.createComment(""), Ie = (t) => t === null || typeof t != "object" && typeof t != "function", Pt = Array.isArray, Bs = (t) => Pt(t) || typeof (t == null ? void 0 : t[Symbol.iterator]) == "function", lt = `[ 	
\f\r]`, ke = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, n1 = /-->/g, a1 = />/g, me = RegExp(`>|${lt}(?:([^\\s"'>=/]+)(${lt}*=${lt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), r1 = /'/g, c1 = /"/g, ys = /^(?:script|style|textarea|title)$/i, Ns = (t) => (e, ...s) => ({ _$litType$: t, strings: e, values: s }), g = Ns(1), X = Symbol.for("lit-noChange"), C = Symbol.for("lit-nothing"), l1 = /* @__PURE__ */ new WeakMap(), ge = Ce.createTreeWalker(Ce, 129);
function Ls(t, e) {
...
const Rs = (t, e) => {
  ...
  for (let r = 0; r < s; r++) {
    const c = t[r];
    let h, d, u = -1, m = 0;
    for (; m < c.length && (a.lastIndex = m, d = a.exec(c), d !== null); ) m = a.lastIndex, a === ke ? d[1] === "!--" ? a = n1 : d[1] !== void 0 ? a = a1 : d[2] !== void 0 ? (ys.test(d[2]) && (o = RegExp("</" + d[2], "g")), a = me) : d[3] !== void 0 && (a = me) : a === me ? d[0] === ">" ? (a = o ?? ke, u = -1) : d[1] === void 0 ? u = -2 : (u = a.lastIndex - d[2].length, h = d[1], a = d[3] === void 0 ? me : d[3] === '"' ? c1 : r1) : a === c1 || a === r1 ? a = me : a === n1 || a === a1 ? a = ke : (a = me, o = void 0);
    const l = a === me && t[r + 1].startsWith("/>") ? " " : "";
    n += a === ke ? c + Zs : u >= 0 ? (i.push(h), c.slice(0, u) + vs + c.slice(u) + ne + l) : c + ne + (u === -2 ? r : l);
  }
...
class Te {
  constructor({ strings: e, _$litType$: s }, i) {
    ...
    this.parts = [];
    let n = 0, a = 0;
    const r = e.length - 1, c = this.parts, [h, d] = Rs(e, s);
    if (this.el = Te.createElement(h, i), ge.currentNode = this.el.content, s === 2 || s === 3) {
      const u = this.el.content.firstChild;
      u.replaceWith(...u.childNodes);
    }
    for (; (o = ge.nextNode()) !== null && c.length < r; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const u of o.getAttributeNames()) if (u.endsWith(vs)) {
          const m = d[a++], l = o.getAttribute(u).split(ne), _ = /([.?@])?(.*)/.exec(m);
          c.push({ type: 1, index: n, name: _[2], strings: l, ctor: _[1] === "." ? Us : _[1] === "?" ? js : _[1] === "@" ? Gs : nt }), o.removeAttribute(u);
        ...
        if (ys.test(o.tagName)) {
          ...
          if (m > 0) {
            ...
            for (let l = 0; l < m; l++) o.append(u[l], ze()), ge.nextNode(), c.push({ type: 2, index: ++n });
            o.append(u[m], ze());
          }
        }
      } else if (o.nodeType === 8) if (o.data === Cs) c.push({ type: 2, index: n });
      else {
        let u = -1;
...
let Fs = class {
  ...
  u(e) {
    const { el: { content: s }, parts: i } = this._$AD, o = ((e == null ? void 0 : e.creationScope) ?? Ce).importNode(s, !0);
    ge.currentNode = o;
    let n = ge.nextNode(), a = 0, r = 0, c = i[0];
    for (; c !== void 0; ) {
      if (a === c.index) {
        let h;
        c.type === 2 ? h = new xe(n, n.nextSibling, this, e) : c.type === 1 ? h = new c.ctor(n, c.name, c.strings, this, e) : c.type === 6 && (h = new Ws(n, this, e)), this._$AV.push(h), c = i[++r];
      }
      a !== (c == null ? void 0 : c.index) && (n = ge.nextNode(), a++);
    }
    return ge.currentNode = Ce, o;
  }
  p(e) {
    let s = 0;
...
class xe {
  ...
  constructor(e, s, i, o) {
    this.type = 2, this._$AH = C, this._$AN = void 0, this._$AA = e, this._$AB = s, this._$AM = i, this.options = o, this._$Cv = (o == null ? void 0 : o.isConnected) ?? !0;
  }
  get parentNode() {
  ...
  _$AI(e, s = this) {
    e = Me(this, e, s), Ie(e) ? e === C || e == null || e === "" ? (this._$AH !== C && this._$AR(), this._$AH = C) : e !== this._$AH && e !== X && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Bs(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== C && Ie(this._$AH) ? this._$AA.nextSibling.data = e : this.T(Ce.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var n;
  ...
  k(e) {
    ...
    const s = this._$AH;
    let i, o = 0;
    for (const n of e) o === s.length ? s.push(i = new xe(this.O(ze()), this.O(ze()), this, this.options)) : i = s[o], i._$AI(n), o++;
...
class nt {
  ...
  _$AI(e, s = this, i, o) {
    ...
    if (n === void 0) e = Me(this, e, s, 0), a = !Ie(e) || e !== this._$AH && e !== X, a && (this._$AH = e);
      ...
      const r = e;
      let c, h;
      for (e = n[0], c = 0; c < n.length - 1; c++) h = Me(this, r[i + c], s, c), h === X && (h = this._$AH[c]), a || (a = !Ie(h) || h !== this._$AH[c]), h === C ? e = C : e !== C && (e += (h ?? "") + n[c + 1]), this._$AH[c] = h;
    }
    a && !o && this.j(e);
  }
  j(e) {
...
const Ks = { I: xe }, ht = De.litHtmlPolyfillSupport;
ht == null || ht(Te, xe), (De.litHtmlVersions ?? (De.litHtmlVersions = [])).push("3.3.1");
const bs = (t, e, s) => {
  const i = (s == null ? void 0 : s.renderBefore) ?? e;
  let o = i._$litPart$;
  if (o === void 0) {
    const n = (s == null ? void 0 : s.renderBefore) ?? null;
    i._$litPart$ = o = new xe(e.insertBefore(ze(), n), n, void 0, s ?? {});
  }
  return o._$AI(t), o;
};
/**
...
let Y = class extends Ae {
  ...
  update(e) {
    const s = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(e), this._$Do = bs(s, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var e;
...
var fs;
Y._$litElement$ = !0, Y.finalized = !0, (fs = ve.litElementHydrateSupport) == null || fs.call(ve, { LitElement: Y });
const dt = ve.litElementPolyfillSupport;
dt == null || dt({ LitElement: Y });
(ve.litElementVersions ?? (ve.litElementVersions = [])).push("4.2.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Dt = { ATTRIBUTE: 1, CHILD: 2 }, Ne = (t) => (...e) => ({ _$litDirective$: t, values: e });
let Re = class {
  constructor(e) {
  }
  get _$AU() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const J = Ne(class extends Re {
  constructor(t) {
    var e;
    if (super(t), t.type !== Dt.ATTRIBUTE || t.name !== "class" || ((e = t.strings) == null ? void 0 : e.length) > 2) throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.");
  }
  render(t) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { I: Xs } = Ks, h1 = (t, e) => (t == null ? void 0 : t._$litType$) !== void 0, Js = (t) => {
  var e;
  ...
  if (s === void 0) {
    ...
    if (c) {
      let h;
      (n = s._$AQ) == null || n.call(s, t), s._$AM = t, s._$AP !== void 0 && (h = t._$AU) !== r._$AU && s._$AP(h);
    }
    if (a !== o || c) {
      let h = s._$AA;
      for (; h !== a; ) {
        const d = h.nextSibling;
        i.insertBefore(h, o), h = d;
      }
    }
  }
  return s;
}, _e = (t, e, s = t) => (t._$AI(e, s), t), Qs = {}, Ct = (t, e = Qs) => t._$AH = e, yt = (t) => t._$AH, ut = (t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const u1 = (t) => Js(t) ? t._$litType$.h : t.strings, p1 = Ne(class extends Re {
  constructor(t) {
  ...
  update(t, [e]) {
    ...
    if (s !== null && (i === null || s !== i)) {
      ...
      if (n === void 0) {
        ...
        n = bs(C, a), n.setConnected(!1), this.et.set(s, n);
      }
      Ct(n, [o]), fe(n, void 0, o);
    }
    if (i !== null) {
      if (s === null || s !== i) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const As = "important", ti = " !" + As, E = Ne(class extends Re {
  constructor(t) {
    var e;
    if (super(t), t.type !== Dt.ATTRIBUTE || t.name !== "style" || ((e = t.strings) == null ? void 0 : e.length) > 2) throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.");
  }
  render(t) {
  ...
  update(t, [e]) {
    ...
    for (const i in e) {
      ...
      if (o != null) {
        ...
        i.includes("-") || n ? s.setProperty(i, n ? o.slice(0, -11) : o, n ? As : "") : s[i] = o;
      }
    }
    return X;
  }
...
const m1 = (t, e, s) => {
  ...
  return i;
}, te = Ne(class extends Re {
  constructor(t) {
    if (super(t), t.type !== Dt.CHILD) throw Error("repeat() can only be used in text expressions");
  }
  dt(t, e, s) {
    let i;
  ...
  update(t, [e, s, i]) {
    ...
    let h, d, u = 0, m = o.length - 1, l = 0, _ = n.length - 1;
    for (; u <= m && l <= _; ) if (o[u] === null) u++;
    else if (o[m] === null) m--;
    else if (r[u] === a[l]) c[l] = _e(o[u], n[l]), u++, l++;
    else if (r[m] === a[_]) c[_] = _e(o[m], n[_]), m--, _--;
    else if (r[u] === a[_]) c[_] = _e(o[u], n[_]), fe(t, c[_ + 1], o[u]), u++, _--;
    else if (r[m] === a[l]) c[l] = _e(o[m], n[l]), fe(t, o[u], o[m]), m--, l++;
    else if (h === void 0 && (h = m1(a, l, _), d = m1(r, u, m)), h.has(r[u])) if (h.has(r[m])) {
      const p = d.get(a[l]), f = p !== void 0 ? o[p] : null;
      if (f === null) {
        const L = fe(t, o[u]);
        _e(L, n[l]), c[l] = L;
      } else c[l] = _e(f, n[l]), fe(t, o[u], f), o[p] = null;
      l++;
    } else ut(o[m]), m--;
    else ut(o[u]), u++;
    for (; l <= _; ) {
...
const zt = ["sensor"], It = ["binary_sensor"], Tt = ["cover"], Lt = ["climate"], No = ["camera"], Qe = [
  ...
  binary_sensor: {
    ...
    off: _t,
    motion: { on: Yi, off: Xi },
    moisture: { on: ko, off: Do },
    window: { on: ss, off: ts },
    door: { on: E1, off: S1 },
    lock: { on: Z1, off: T1 },
    presence: { on: Ni, off: Bi },
    occupancy: { on: mo, off: _o },
    vibration: { on: So, off: Eo },
    opening: { on: Co, off: vo },
  ...
  valve: { on: wo, off: Y1 },
  water_heater: { on: Po, off: zo },
  remote: { on: no, off: ao },
  update: { on: C1, off: y1 },
  air_quality: { on: v1, off: v1 },
  camera: { on: Ci, off: yi },
  calendar: { on: A1, off: H1 },
  scene: { on: Ji, off: Qi },
  notifications: { on: _i, off: b1 },
  sensor: { on: D1, off: D1 },
  script: { on: W1, off: W1 },
  tags: { on: q1, off: q1 },
  select: { on: Ge, off: Ge },
  ...
  tts: { on: X1, off: J1 },
  wake_word: { on: Ki, off: qi },
  weather: { on: Io, off: Q1 },
  zone: { on: B1, off: N1 },
  geo_location: { on: B1, off: N1 }
}, Ro = A(
  ...
  (t, e) => zt.flatMap((s) => s in t ? e[s].map(
    (i, o) => ({
      domain: s,
      deviceClass: i,
      index: o
  ...
  if (typeof t == "object")
    return Object.entries(t).reduce(
      (n, [a, r]) => {
        const c = a.startsWith("--") ? a : a.replace(/-([a-z])/g, (h, d) => d.toUpperCase());
  ...
  const o = t.replace(/\/\*[\s\S]*?\*\//g, "").replace(/\n/g, " ").split(";").map((n) => n.trim()).filter((n) => n && n.includes(":")).reduce(
    (n, a) => {
      const r = a.split(":"), c = r[0], h = r.slice(1).join(":");
      if (c && h !== void 0) {
        const d = c.trim(), u = d.startsWith("--") ? d : d.replace(/-([a-z])/g, (m, l) => l.toUpperCase());
        n[u] = h.trim();
      }
      return n;
    },
...
}, $s = (t, e, s) => e && e._parsedCss ? e._parsedCss : t ? Vs(t, s) : {}, Go = A(
  (t, e, s, i, o) => {
    const n = {
...
`, Q = [
  ...
  "not_home",
  "disarmed"
], Ko = "unavailable", qo = "unknown", ee = [Ko, qo], Yo = (t, e, s, i, o) => {
  var u, m, l, _, p;
  ...
  if (n && n !== "default" && ((m = e == null ? void 0 : e.themes) != null && m[n])) {
    const { modes: f, ...L } = e.themes[n] || {};
    c = { ...c, ...L }, f && (a && f.dark ? c = { ...c, ...f.dark } : !a && f.light && (c = { ...c, ...f.light }));
  } else if (!n && (!((l = t.__themes) != null && l.keys) || t.__themes.keys.size === 0))
    return;
  const h = ((_ = t.__themes) == null ? void 0 : _.keys) || /* @__PURE__ */ new Set(), d = new Set(Object.keys(c));
  ...
  for (const [f, L] of Object.entries(c))
    t.style.setProperty(`--${f}`, String(L));
...
), vn = (t, e) => t < e ? -1 : t > e ? 1 : 0, Cn = (t, e, s = void 0) => Intl != null && Intl.Collator ? gn(s).compare(t, e) : vn(t.toLowerCase(), e.toLowerCase()), yn = (t) => {
  switch (t.language) {
    case "cs":
    case "de":
    case "fi":
...
const vt = (t, e) => {
  ...
  if (e === "domain") {
    const m = r === "toggle" || (r == null ? void 0 : r.action) === "toggle", l = r === "more-info" || (r == null ? void 0 : r.action) === "more-info";
    if (m) {
      ...
      if (s !== "binary_sensor" && s !== "sensor")
        if (s === "climate") {
          const p = (u = (d = t._config) == null ? void 0 : d.customization_domain) == null ? void 0 : u.find(
            (L) => L.type === "climate"
          ), f = p == null ? void 0 : p.display_mode;
          (f === "icon" || f === "text_icon") && t._showPopupForDomain(s);
        } else
  ...
  if (e === "custom_button" && (o != null && o.entity) && c) {
    const m = o.entity, l = new CustomEvent("hass-more-info", {
      bubbles: !0,
      composed: !0,
      detail: { entityId: m }
    });
...
const Ht = (t, e) => {
  ...
  (t, e, s, i, o, n) => {
    ...
    return n && n.has(t) ? a = Array.from(n.get(t)) : a = Object.values(s).filter((r) => {
      ...
      const c = s[r];
      return !c || c.hidden || i.has(r) ? !1 : Array.isArray(o) && o.length > 0 ? c.labels && c.labels.some((h) => o.includes(h)) : !0;
    });
  }
), ce = A(
  (t, e) => new Set(
  ...
  if (!a.length)
    return;
  const r = a.reduce((d, u) => d + Number(u.state), 0);
  let c;
  if (o)
    for (const d of a) {
      const u = o[d.entity_id], m = fn(d, u);
  ...
  return e === "power" ? `${ns(r, i, h)}${n ? rs(n, i) : ""}${n || ""}` : `${ns(r / a.length, i, h)}${n ? rs(n, i) : ""}${n || ""}`;
}, us = (t, e, s) => {
  if (t in Ze) {
    const i = Ze[t];
...
const xn = /* @__PURE__ */ new Set(), Sn = [ee, Q], Bt = class Bt extends Y {
  constructor() {
    super(...arguments), this._onPopState = (e) => {
      ...
      (e, s, i, o, n, a, r) => {
        const c = new Set(
          ...
          r
        ), d = s == null ? void 0 : s.category_filter, u = (m) => $e(m, e, d);
        return h.filter((m) => {
          if (!u(m)) return !1;
          const l = I(m);
          return !(n.length > 0 && !n.includes(l) || a && l !== a);
        });
      }
    ), this.computeLabel = A(
  ...
  async _createCardElement(e, s, i = !1) {
    ...
    try {
      const r = s.type || "tile", c = typeof r == "string" && r.startsWith("custom:"), h = c ? r.slice(7) : `hui-${r}-card`;
      c && !customElements.get(h) && await customElements.whenDefined(h).catch(() => {
      });
  ...
  _getPopupCardConfig(e) {
    var l, _, p, f, L, $, V, v, b, w, k;
    const s = this.card, i = I(e.entity_id), o = this.selectedDomain || i, n = this.selectedDomain ? this.selectedDeviceClass : (f = (p = (_ = (l = this.hass) == null ? void 0 : l.states) == null ? void 0 : _[e.entity_id]) == null ? void 0 : p.attributes) == null ? void 0 : f.device_class, a = (s == null ? void 0 : s._config) || {};
    let r;
    It.includes(o) ? (r = (L = a.customization_alert) == null ? void 0 : L.find(
      (M) => M.type === n
    ), r || (r = ($ = a.customization_domain) == null ? void 0 : $.find(
      (M) => M.type === o
    ))) : zt.includes(o) ? (r = (V = a.customization_sensor) == null ? void 0 : V.find(
      (M) => M.type === n
    ), r || (r = (v = a.customization_domain) == null ? void 0 : v.find(
      (M) => M.type === o
    ))) : Tt.includes(o) ? (r = (b = a.customization_cover) == null ? void 0 : b.find(
      (M) => M.type === n
    ...
    const c = r == null ? void 0 : r.popup_card, h = c && typeof c.type == "string" && c.type || (r == null ? void 0 : r.popup_card_type) || "tile", d = h === "tile" ? this.DOMAIN_FEATURES[i] ?? {} : {};
    let u = {};
    if (c && typeof c == "object") {
      const { type: M, entity: y, ...S } = c;
      u = S;
    } else
  ...
  sortEntitiesForPopup(e) {
    ...
    if (s === "state") {
      ...
      return i.sort((c, h) => {
        const d = this._isActive(c) ? 0 : 1, u = this._isActive(h) ? 0 : 1;
        if (d !== u) return d - u;
        const m = I(c.entity_id), l = I(h.entity_id), _ = this.hass ? hs(this.hass, c.state, m) : c.state, p = this.hass ? hs(this.hass, h.state, l) : h.state, f = (_ || "").localeCompare(p || "");
        return f !== 0 ? f : r(c.entity_id, h.entity_id);
      });
    }
    const o = Ve(
      this.hass.states,
  ...
  render() {
    var b, w, k, M, y, S, z, T, P;
    if (!this.hass || !this.card) return g``;
    const e = this.card, { areaId: s, devicesInArea: i, entitiesIndex: o } = this._getAreaEntitiesContext(), n = this.hass.states, a = ((b = e._config) == null ? void 0 : b.popup_domains) || [], r = ((w = e._config) == null ? void 0 : w.extra_entities) || [], c = (k = e._config) == null ? void 0 : k.hide_unavailable, h = (M = e._config) == null ? void 0 : M.category_filter, d = this.selectedDomain || null, u = this.selectedDeviceClass || null, m = (H) => $e(H, this.hass.entities, h);
    let l = [];
    this.entities && this.entities.length > 0 ? l = this.entities.reduce((H, O) => {
      const x = O.entity_id;
      if (!m(x)) return H;
      const B = I(x);
      return a.length > 0 && !a.includes(B) || d && B !== d || H.push(x), H;
    }, []) : l = this._getCandidateEntityIds(
      this.hass.entities,
      e._config,
      s,
      i,
    ...
    for (const H of l) {
      const O = n[H];
      O && (c && ee.includes(O.state) || u && O.attributes.device_class !== u || _.push(O));
    }
    for (const H of r) {
      const O = I(H), x = n[H];
      x && (a.length > 0 && !a.includes(O) || d && O !== d || u && x.attributes.device_class !== u || m(H) && !_.some((B) => B.entity_id === H) && _.push(x));
    }
    const p = ((y = e == null ? void 0 : e._config) == null ? void 0 : y.ungroup_areas) === !0;
    let f = (S = e._config) != null && S.columns ? e._config.columns : 4, L = [], $ = [];
    if (p)
      $ = this.sortEntitiesForPopup(_), f = Math.min(f, Math.max(1, $.length));
    else {
      const H = {};
      for (const R of _) {
        const K = I(R.entity_id);
        K in H || (H[K] = []), H[K].push(R);
      }
      const O = Object.keys(Ze || {}), x = a.length > 0 ? a : O;
      L = Object.entries(H).filter(([R]) => !d || R === d).sort(([R], [K]) => {
        const Se = x.indexOf(R), Ee = x.indexOf(K);
        return (Se === -1 ? x.length : Se) - (Ee === -1 ? x.length : Ee);
      }).map(
        ([R, K]) => [R, this.sortEntitiesForPopup(K)]
      );
      const B = L.length ? Math.max(...L.map(([, R]) => R.length)) : 0;
      f = Math.min(f, Math.max(1, B));
    }
    if (this.style.setProperty("--columns", String(f)), !(L.length > 0 || $.length > 0))
      return g`
        <ha-adaptive-dialog
          .hass=${this.hass}
          .open=${this.open}
      ...
      `;
    const v = Vt((z = e._config) == null ? void 0 : z.area, (T = e.hass) == null ? void 0 : T.areas) ?? null;
    return g`
      <ha-adaptive-dialog
        .hass=${this.hass}
        .open=${this.open}
      ...
      ([H, O]) => g`
                    <div class="cards-wrapper">
                      <h4>
                        ${H === "binary_sensor" || H === "sensor" || H === "cover" ? this._getDomainName(
        H,
        u || void 0
      ) : this._getDomainName(H)}
                      </h4>
                      <div class="entity-cards">
                        ${te(
        O,
...
let se = class extends Y {
    ...
    super(...arguments), this.selectedDomain = null, this.selectedDeviceClass = null, this.selectedGroup = null, this._currentCameraIndex = 0, this._iconCache = /* @__PURE__ */ new Map(), this._styleCache = /* @__PURE__ */ new Map(), this._deviceClasses = bt, this._customizationDomainMap = /* @__PURE__ */ new Map(), this._customizationCoverMap = /* @__PURE__ */ new Map(), this._customizationAlertMap = /* @__PURE__ */ new Map(), this._customizationSensorMap = /* @__PURE__ */ new Map(), this._actionHandlerCache = /* @__PURE__ */ new Map(), this._hiddenEntitiesSet = /* @__PURE__ */ new Set(), this._excludedEntitiesSet = /* @__PURE__ */ new Set(), this._getOrganizedEntities = A(
      (t, e, s) => {
        ...
        for (const n of t) {
          ...
          if (!a) continue;
          const r = I(n);
          if (!Qe.includes(r) && !zt.includes(r) && !It.includes(r) && !Tt.includes(r) && !No.includes(r) && !Lt.includes(r))
            continue;
          o[r] || (o[r] = []), o[r].push(a), i.has(r) || i.set(r, /* @__PURE__ */ new Map());
          const c = i.get(r), h = a.attributes.device_class || "default";
  ...
  setConfig(t) {
    ...
    this._config = t, this._deviceClasses = { ...bt }, t.sensor_classes && (this._deviceClasses.sensor = t.sensor_classes), t.alert_classes && (this._deviceClasses.binary_sensor = t.alert_classes), t.cover_classes && (this._deviceClasses.cover = t.cover_classes), this._iconCache.clear(), this._styleCache.clear();
  ...
  _handleAction(t) {
    ...
    const i = {
      ...
      double_tap_action: (h = this._config) == null ? void 0 : h.double_tap_action
    };
    At(this, this.hass, i, t.detail.action);
  }
  _cachedIcon(t, e, s) {
    const i = `${t}|${s || ""}|${e ? "1" : "0"}`;
  ...
  _renderEntityGroup(t, e, s, i) {
    var d, u, m, l;
    const o = t === "cover", n = o ? "open" : "on", a = o ? (d = this._config) == null ? void 0 : d.cover_color : (u = this._config) == null ? void 0 : u.alert_color, r = o ? (m = this._config) == null ? void 0 : m.cover_css : (l = this._config) == null ? void 0 : l.alert_css, c = o ? "cover" : "alert", h = o ? (_, p) => Mn(this, _, p) : (_, p) => $n(this, _, p);
    return g`
      <div class="${J({ [t + "s"]: !0, ...this._designClasses })}">
        ${te(
      e,
      (_) => _.domain + "-" + _.deviceClass,
      ({ domain: _, deviceClass: p }) => {
        var k, M, y, S, z, T;
        const f = i.get(p), L = (f == null ? void 0 : f.invert) === !0, V = (((k = s.get(_)) == null ? void 0 : k.get(p)) || []).filter((P) => {
          var O;
          const H = P.state === n;
          return (L ? Q.includes(P.state) : H) && !this._excludedEntitiesSet.has(P.entity_id) && $e(P.entity_id, this.hass.entities, (O = this._config) == null ? void 0 : O.category_filter);
        }), v = (f == null ? void 0 : f.color) || a, b = f == null ? void 0 : f.icon, w = V.length;
        return w > 0 ? g`
                  <div
                    class="icon-with-count hover"
                    style=${E(this._getParsedCss(
          ((M = f == null ? void 0 : f.styles) == null ? void 0 : M.button) || ((y = f == null ? void 0 : f.styles) == null ? void 0 : y.card) || r || ((z = (S = this._config) == null ? void 0 : S.styles) == null ? void 0 : z[c]),
          f
        ))}
                    @action=${h(_, p)}
                    .actionHandler=${q(f)}
                  >
                    ${this._renderIcon(
          b || this._cachedIcon(_, !L, p),
          E({
            ...v ? { color: `var(--${v}-color)` } : {},
            ...this._getParsedCss((T = f == null ? void 0 : f.styles) == null ? void 0 : T.icon, f)
          }),
          t
        )}
  ...
  _renderSingleCustomButton(t, e) {
    var r, c, h, d, u, m;
    if (t.conditional) {
      const l = t.entity ? I(t.entity) : null;
      if (l && l in e) {
        const _ = e[l].find(
          (p) => p.entity_id === t.entity
        );
        if (!_ || ee.includes(_.state) || Q.includes(_.state))
          return C;
      }
    }
    if (t.state_mode && t.entity && t.state_value) {
      const l = this.hass.states[t.entity];
      if (!l) return C;
      const _ = l.state === t.state_value;
      if (t.state_mode === "equal" && !_ || t.state_mode === "not_equal" && _)
        return C;
    }
    let s;
    t.entity && (s = this.hass.states[t.entity]);
    let i;
    t.activate_state_color && s && (!t.color || t.color === "state") && (i = dn(s));
    const o = i ? { color: i } : t.color ? { color: `var(--${t.color}-color, ${t.color})` } : {};
    let n = t.icon;
    if (!n && s && (n = s.attributes.icon, !n)) {
      const l = I(s.entity_id), _ = !ee.includes(s.state) && !Q.includes(s.state);
      n = us(l, _, s.attributes.device_class);
    }
    const a = !!t.name;
    return g`
      <div
        ...
        style=${E(
      this._getParsedCss(
        ((r = t.styles) == null ? void 0 : r.button) || ((c = t.styles) == null ? void 0 : c.card) || t.css,
        t
      )
    )}
        @action=${Fe(
      ...
      t
        ...
        .actionHandler=${q(t)}
      >
        ${t.use_entity_picture && ((h = s == null ? void 0 : s.attributes) != null && h.entity_picture) ? g`<img
                    class="entity-picture"
                    src=${s.attributes.entity_picture}
                    style=${E({
      ...
      E({
        ...o,
        ...this._getParsedCss(((u = t.styles) == null ? void 0 : u.icon) || t.icon_css, t)
      })
    ) : C}
        ${a ? g`<span class="custom-button-label" style=${E({
      ...o,
      ...this._getParsedCss((m = t.styles) == null ? void 0 : m.name, t)
    })}"
                    >${t.name}</span
                  >` : C}
      </div>
  ...
  renderCustomButtons(t) {
    ...
    const e = this._config.custom_buttons.filter(
      (i) => !i.position || i.position === "default"
    );
    return e.length === 0 ? C : g`
      <div
        class="${J({
      custom_buttons: !0,
      ...this._designClasses
      ...
      >
        ${e.map((i) => this._renderSingleCustomButton(i, t))}
      </div>
    `;
  }
  renderPositionedCustomButtons(t) {
    var a;
    if (!((a = this._config) != null && a.custom_buttons) || this._config.custom_buttons.length === 0)
      return C;
    const e = this._config.custom_buttons.filter(
    ...
    if (e.length === 0)
      return C;
    const s = (r) => r && !/[^0-9]/.test(r) ? `${r}px` : r, i = /* @__PURE__ */ new Map(), o = /* @__PURE__ */ new Map();
    for (const r of e)
      if (r.position_group) {
        const c = r.position_group;
        i.has(c) || i.set(c, []), i.get(c).push(r);
      } else {
        const c = r.position || "custom";
        o.has(c) || o.set(c, []), o.get(c).push(r);
      }
    const n = [
      ...Array.from(o.entries()).map(([r, c]) => {
        var h;
        return { position: r, buttons: c, direction: (h = c[0]) == null ? void 0 : h.position_direction };
      }),
      ...Array.from(i.entries()).map(([r, c]) => {
        var h, d;
        return { position: ((h = c[0]) == null ? void 0 : h.position) || "custom", buttons: c, direction: (d = c[0]) == null ? void 0 : d.position_direction };
      })
    ];
    return g`
      ${n.map(({ position: r, buttons: c, direction: h }) => {
      const d = r === "custom" ? (() => {
        const m = c[0];
        return {
          ...m.position_top ? { top: s(m.position_top) } : {},
          ...m.position_right ? { right: s(m.position_right) } : {},
          ...m.position_bottom ? { bottom: s(m.position_bottom) } : {},
          ...m.position_left ? { left: s(m.position_left) } : {}
        };
      })() : {};
      return g`
          <div
            class="positioned-button-group ${r !== "custom" ? r : ""}"
            style=${E({ ...d, flexDirection: h === "column" ? "column" : "row" })}
          >
            ${c.map((m) => {
        var l, _;
        return g`
              <div
                ...
                style=${E(
          this._getParsedCss(((l = m.styles) == null ? void 0 : l.button) || ((_ = m.styles) == null ? void 0 : _.card) || m.css, m)
        )}
              >
                ${this._renderSingleCustomButton(m, t)}
              </div>
            `;
      })}
          </div>
  ...
  _renderButtons(t, e, s) {
    return g`
      ...
      (i) => i,
      (i) => {
        var p, f, L, $, V, v, b, w, k, M;
        if (i === "climate") {
          const y = s.get("climate"), S = y == null ? void 0 : y.display_mode;
          if (y && y.hide === !0 || S !== "icon" && S !== "text_icon")
            return C;
        }
        const o = s.get(i), n = (o == null ? void 0 : o.color) || ((p = this._config) == null ? void 0 : p.domain_color), a = o == null ? void 0 : o.icon, r = i === "climate" ? s.get("climate") : void 0, c = r == null ? void 0 : r.display_mode, h = r == null ? void 0 : r.show_set_temperature, d = i === "climate" && (c === "icon" || c === "text_icon") && h === !0, u = e[i].filter((y) => !(ee.includes(y.state) || this._excludedEntitiesSet.has(y.entity_id)));
        let m = [], l;
        if (d) {
          m = u;
          let y = !1, S = !1;
          for (const z of u) {
            const T = ((f = z.attributes) == null ? void 0 : f.hvac_action) ?? null, P = (z.state ?? "").toString().toLowerCase();
            if (T != null) {
              const H = T.toString().toLowerCase();
              y = y || H.includes("heat") || H.includes("heating"), S = S || H.includes("cool") || H.includes("cooling");
            } else
              y = y || P.includes("heat") || P.includes("heating"), S = S || P.includes("cool") || P.includes("cooling");
            if (y && S) break;
          }
          y ? l = this._getClimateColor("heat", "red") : S ? l = this._getClimateColor("cool", "cornflowerblue") : l = this._getClimateColor("standby", "") || ((L = this._config) == null ? void 0 : L.climate_standby_color);
        } else
          m = u.filter((y) => {
            var S;
            if (i === "climate") {
              const z = (S = y.attributes) == null ? void 0 : S.hvac_action;
              if (z != null) {
                const P = z.toString().toLowerCase();
                return !(P === "off" || P === "idle");
              }
              const T = (y.state ?? "").toString().toLowerCase();
              return !(T === "off" || T === "idle");
            }
            return !Q.includes(y.state);
          });
        const _ = m.length;
        return this._config.show_active && _ === 0 ? C : g`
              <div
                class="icon-with-count hover"
                style=${E(
          this._getParsedCss(
            (($ = o == null ? void 0 : o.styles) == null ? void 0 : $.button) || ((V = o == null ? void 0 : o.styles) == null ? void 0 : V.card) || (o == null ? void 0 : o.css) || ((v = this._config) == null ? void 0 : v.domain_css) || ((w = (b = this._config) == null ? void 0 : b.styles) == null ? void 0 : w.domain),
            o
          )
        )}
                @action=${vt(this, i)}
              ...
              >
                ${this._renderIcon(
          a || this._cachedIcon(i, _ > 0),
          E({
            ...l ? { color: l } : {},
            ...!l && n ? { color: `var(--${n}-color)` } : {},
            ...!l && !n && ((k = this._config) != null && k.domain_color) ? { color: this._config.domain_color } : {},
            ...this._getParsedCss(((M = o == null ? void 0 : o.styles) == null ? void 0 : M.icon) || (o == null ? void 0 : o.icon_css), o)
          }),
          _ > 0 ? "toggle-on" : "toggle-off",
          i
        )}
                <span
                  class="active-count text-small ${_ > 0 ? "on" : "off"}"
                >
                  ${_}
                </span>
              </div>
  ...
  _renderSensors(t, e, s, i, o) {
    ...
    return g`
      ...
      ({ domain: c, deviceClass: h, index: d }) => {
        var b, w, k, M, y, S, z, T, P, H, O;
        const m = (((b = s.get(c)) == null ? void 0 : b.get(h)) || []).filter(
          (x) => {
            var B;
        ...
        switch (h) {
          case "temperature":
            l = i.temperature_entity_id;
            break;
          case "humidity":
            l = i.humidity_entity_id;
            break;
        }
        const _ = l ? this.hass.states[l] : void 0, p = o.get(h), f = (p == null ? void 0 : p.color) || ((w = this._config) == null ? void 0 : w.sensor_color), L = (p == null ? void 0 : p.invert) === !0, $ = m.some(
        ...
        const V = (k = this._config) != null && k.show_sensor_icons ? g`<ha-domain-icon
          ...
          ...f ? { color: `var(--${f}-color)` } : {},
          ...this._getParsedCss(
            ((M = p == null ? void 0 : p.styles) == null ? void 0 : M.icon) || (p == null ? void 0 : p.css),
            p
          )
        })}
                      .hass=${this.hass}
          ...
          ...f ? { color: `var(--${f}-color)` } : {},
          ...this._getParsedCss(
            (S = (y = this._config) == null ? void 0 : y.styles) == null ? void 0 : S.sensor,
            this._config
          ),
          ...this._getParsedCss(
            ((z = p == null ? void 0 : p.styles) == null ? void 0 : z.sensor) || ((T = p == null ? void 0 : p.styles) == null ? void 0 : T.button) || ((P = p == null ? void 0 : p.styles) == null ? void 0 : P.card) || (p == null ? void 0 : p.css),
            p
          )
        })}
                >
                  ${!((H = this._config) != null && H.show_sensor_icons) && !((O = this._config) != null && O.wrap_sensor_icons) && d > 0 ? " - " : ""}
                  ${_ ? this.hass.formatEntityState(_) : ds(
          c,
          h,
          m,
          this.hass.locale,
        ...
        return g`<div class="sensor-row off">${V}${v}</div>`;
      }
    ...
    return g`
      ...
      ({ domain: i }) => {
        ...
        if ((n == null ? void 0 : n.show_set_temperature) === !0) {
          const p = o.filter(($) => !this._excludedEntitiesSet.has($.entity_id)).map(($) => {
            var P, H, O, x, B, R;
            const V = ((P = $.attributes) == null ? void 0 : P.temperature) ?? ((H = $.attributes) == null ? void 0 : H.target_temperature) ?? null;
            if (V == null) return null;
            const v = Number(V);
            if (Number.isNaN(v)) return null;
            const b = ((B = (x = (O = this.hass) == null ? void 0 : O.config) == null ? void 0 : x.unit_system) == null ? void 0 : B.temperature) || "", w = ((R = $.attributes) == null ? void 0 : R.hvac_action) ?? null, k = ($.state ?? "").toString().toLowerCase(), M = (w ?? k).toString().toLowerCase(), y = M.includes("heat") || M.includes("heating"), S = M.includes("cool") || M.includes("cooling"), z = y ? this._getClimateStyle("heat") : S ? this._getClimateStyle("cool") : this._getClimateStyle("standby"), T = z.color || (y ? "red" : S ? "cornflowerblue" : "var(--secondary-text-color)");
          ...
          const f = p.reduce(
            ...
            ...this._getParsedCss(
              ((d = n == null ? void 0 : n.styles) == null ? void 0 : d.button) || ((u = n == null ? void 0 : n.styles) == null ? void 0 : u.card) || (n == null ? void 0 : n.css),
              n
            )
          };
          return g`<div
        ...
        const r = (o || []).filter((p) => {
          var b;
          const f = (b = p.attributes) == null ? void 0 : b.hvac_action, L = p.state, $ = !ee.includes(L) && !Q.includes(L) && !this._excludedEntitiesSet.has(p.entity_id);
          if (f != null) {
            const w = f.toString().toLowerCase();
            return $ && (w !== "idle" && w !== "off");
          }
          const V = (L ?? "").toString().toLowerCase(), v = V.includes("heat") || V.includes("cool") || V !== "idle" && V !== "off";
          return $ && v;
        }).map((p) => {
          var L, $, V, v;
          return `${((L = p.attributes) == null ? void 0 : L.temperature) ?? "N/A"} ${((v = (V = ($ = this.hass) == null ? void 0 : $.config) == null ? void 0 : V.unit_system) == null ? void 0 : v.temperature) || ""}`;
        });
        if (r.length === 0)
          return C;
        const c = n == null ? void 0 : n.color, h = {
          ...c ? { color: `var(--${c}-color)` } : {},
          ...!c && ((m = this._config) != null && m.domain_color) ? { color: this._config.domain_color } : {},
          ...this._getParsedCss(
            ((l = n == null ? void 0 : n.styles) == null ? void 0 : l.button) || ((_ = n == null ? void 0 : n.styles) == null ? void 0 : _.card) || (n == null ? void 0 : n.css),
            n
          )
        };
        return g`<div
  ...
  _renderBottom(t, e, s, i, o, n, a) {
    ...
    return g`
      ...
      ...this._getParsedCss(
        ((h = (c = this._config) == null ? void 0 : c.styles) == null ? void 0 : h.name) || ((d = this._config) == null ? void 0 : d.name_css),
        this._config
      )
    })}
  ...
  render() {
    var H, O, x, B, R, K, Se, Ee, Nt, Rt, Ft, Ut, jt, Gt;
    if (!this._config || !this.hass || !this.hass.areas || !this.hass.devices || !this.hass.entities)
      return C;
    const t = ((H = this._config) == null ? void 0 : H.design) === "V2", e = t && ((O = this._config) != null && O.v2_color) ? `rgba(${this._config.v2_color.join(", ")})` : "var(--primary-color)", s = {
    ...
    const o = t ? { background: e } : {}, n = t && i === 1 ? {} : t ? { background: e } : {}, a = this.hass.entities && this.hass.devices ? ae(this.hass.entities, this.hass.devices) : void 0, r = re(
      ...
      this._config.label,
      a
    ), { grouped: c, byDomain: h } = this._getOrganizedEntities(
      r,
      this.hass.states,
      this._deviceClasses
    ), d = {};
    Object.entries(h).forEach(([j, pe]) => {
      d[j] = pe.filter(
        (Ue) => {
          var Oe;
          return $e(
    ...
    const u = Vt(this._config.area, ((B = this.hass) == null ? void 0 : B.areas) || {}), m = this._customizationDomainMap, l = this._customizationCoverMap, _ = this._customizationAlertMap, p = this._customizationSensorMap, f = this._computeCovers(d, this._deviceClasses), L = this._computeAlerts(d, this._deviceClasses), $ = this._computeButtons(
      this._config.toggle_domains,
      d
    ), V = this._computeSensors(d, this._deviceClasses), v = ((K = (R = this._config) == null ? void 0 : R.toggle_domains) != null && K.includes("climate") ? Lt : []).filter((j) => j in d).map((j) => ({ domain: j })), b = (((Se = this._config) == null ? void 0 : Se.display_type) || "").toString().toLowerCase(), w = b.includes("camera"), k = b.includes("picture") || b.includes("image"), M = b === "" ? !0 : b.includes("icon"), y = w ? d.camera || [] : [], S = w && (this._config.camera_entity || this._config.camera_entity_left || this._config.camera_entity_right);
    if (u === null)
      return g`
        <hui-warning>
      ...
      `;
    const z = w && (y.length > 0 || S) || k && u.picture, T = Go(
      t,
      i,
      ((Nt = (Ee = this._config) == null ? void 0 : Ee.styles) == null ? void 0 : Nt.icon) || ((Rt = this._config) == null ? void 0 : Rt.icon_css),
    ...
    return g`
      <ha-card
        ...
        style=${E(
      this._getParsedCss(
        ((jt = (Ut = this._config) == null ? void 0 : Ut.styles) == null ? void 0 : jt.card) || ((Gt = this._config) == null ? void 0 : Gt.css),
        this._config
      )
    )}
      >
        <div
          class="header"
          style=${z ? "padding-bottom:0em" : "padding-bottom:12em"}
          @action=${this._handleAction}
          .actionHandler=${q(this._config)}
        >
          <div
          ...
          >
            ${(() => {
      var j, pe, Ue, Oe, Wt, Kt, qt, Yt, Xt, Jt, Qt;
      if (!z) return C;
      if (w && y.length > 0) {
        ...
        if (at === "split") {
          const Le = ((Oe = this._config) == null ? void 0 : Oe.camera_entity_left) || ((Wt = y[0]) == null ? void 0 : Wt.entity_id), be = ((Kt = this._config) == null ? void 0 : Kt.camera_entity_right) || ((qt = y[1]) == null ? void 0 : qt.entity_id);
          if (Le && be)
            return g`
                <div style="display: flex; height: 100%; width: 100%;">
                  <hui-image
                    style=${E({ flex: "1", width: "50%", "object-fit": "cover", ...rt })}
                    .config=${this._config}
                    .hass=${this.hass}
                    .cameraImage=${Le}
          ...
          let Le = (Yt = y[0]) == null ? void 0 : Yt.entity_id;
          return at === "single" && ((Xt = this._config) != null && Xt.camera_entity) ? Le = this._config.camera_entity : at === "auto" && y.length > 0 && (Le = y[this._currentCameraIndex % y.length].entity_id), g`
              ${te([Le], (be) => be, (be) => g`
                <hui-image
                  .config=${this._config}
                  .hass=${this.hass}
                  style=${E({ width: "100%", height: "100%", ...rt })}
                  .cameraImage=${be}
                  .cameraView=${this._config.camera_view}
                  fit-mode="cover"
                ></hui-image>
      ...
      if (k && u.picture)
        return g`
            <hui-image
              .config=${this._config}
              .hass=${this.hass}
              style=${E({ width: "100%", height: "100%", ...this._getParsedCss((Qt = (Jt = this._config) == null ? void 0 : Jt.styles) == null ? void 0 : Qt.image, this._config) })}
              .image=${u.picture}
              fit-mode="cover"
            ></hui-image>
          `;
...
const kn = A(() => [{ name: "area", selector: { area: {} } }]), Pn = A(
  (t, e, s, i, o) => {
              ...
              select: {
                options: [
                  ...
                  const c = (u) => {
                    ...
                    return m === "icon" ? "ui.panel.lovelace.editor.card.generic.icon" : m === "picture" || m === "image" ? "ui.components.selectors.image.image" : m === "camera" ? "ui.panel.lovelace.editor.card.area.display_type_options.camera" : `ui.panel.lovelace.editor.card.area.display_type_options.${u}`;
                  }, d = r.split(" & ").map((u) => u.trim()).map((u) => n(c(u)) || u).join(" & ");
...
var Nn = Object.defineProperty, Rn = Object.getOwnPropertyDescriptor, F = (t, e, s, i) => {
  for (var o = i > 1 ? void 0 : i ? Rn(e, s) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (o = (i ? a(e, s, o) : a(o)) || o);
  return i && o && Nn(e, s, o), o;
};
class ye extends Y {
  constructor() {
      ...
      (e, s) => g`
            <div class="row">
              <div class="item">
                ${(() => {
        var o, n;
        if (e.use_entity_picture && e.entity) {
          const a = (o = this.hass) == null ? void 0 : o.states[e.entity];
          if ((n = a == null ? void 0 : a.attributes) != null && n.entity_picture)
            return g`<img
                        class="entity-picture-preview"
                        src=${a.attributes.entity_picture}
                      />`;
        }
        const i = e.icon;
...
let ie = class extends Y {
  constructor() {
    ...
    ]), this._schemacustombuttonConfigAfter = A(() => [
  ...
  render() {
    ...
    const s = { ...this._config }, i = this.getSchema === "custom_button" && this._activeTab === "config", o = i ? this._schemacustombuttonConfigAfter() : [];
    return g`
      <ha-tab-group>
        <ha-tab-group-tab
      ...
      ${this._activeTab === "style" ? g`
            <ha-alert alert-type="info" title="Style Guide">
              ...
              <ul>
                ...
                ${this.getSchema === "custom_button" ? g`<li><b>name</b>: Item Name (Label)</li>` : C}
              </ul>
              <p>
...
icon:
  ...
  color: var(--primary-color);
      ...
      select: {
        ...
        options: [
          ...
          { value: "custom", label: "Custom" }
                    ...
                    .label=${"Position"}
                    @value-changed=${(l) => {
      this._updatePositionField("position", l.detail.value);
    }}
                  ></ha-selector>
                  ${(a = this._config) != null && a.position && this._config.position !== "default" ? g`
                        <div class="position-grid">
                          <ha-selector
                            .hass=${t}
                            .selector=${{ text: {} }}
                            .value=${((r = this._config) == null ? void 0 : r.position_group) || ""}
                            .label=${"Group"}
                            @value-changed=${(l) => {
      this._updatePositionField("position_group", l.detail.value);
    }}
                          ></ha-selector>
                          <ha-selector
                            .hass=${t}
      ...
      select: {
        ...
        options: [
          ...
          { value: "column", label: "Column" }
                            ...
                            .label=${"Direction"}
                            @value-changed=${(l) => {
      this._updatePositionField("position_direction", l.detail.value);
    }}
                          ></ha-selector>
                        </div>
                      ...
                      ` : C}
                  ${((h = this._config) == null ? void 0 : h.position) === "custom" ? g`
                        <div class="position-grid">
                          <ha-selector
                            .hass=${t}
      ...
      this._updatePositionField(
        ...
        l.detail.value
                      ...
                      ` : C}
                  ${(d = this._config) != null && d.entity ? g`
      ...
      select: {
        ...
        options: [
          ...
          { value: "not_equal", label: "State not equal" }
                            ...
                            .value=${((u = this._config) == null ? void 0 : u.state_mode) || ""}
                            .label=${"Invert State"}
                            @value-changed=${(l) => {
      this._updatePositionField("state_mode", l.detail.value);
    }}
                          ></ha-selector>
                          <ha-selector
                            .hass=${t}
      ...
      state: { entity_id: this._config.entity }
                            ...
                            .value=${((m = this._config) == null ? void 0 : m.state_value) || ""}
                            .label=${"State"}
                            @value-changed=${(l) => {
      this._updatePositionField("state_value", l.detail.value);
    }}
                          ></ha-selector>
                        </div>
                      ` : C}
  ...
  _updatePositionField(t, e) {
    ...
    const s = { ...this.config, [t]: e };
    this._config = s, this.dispatchEvent(
      new CustomEvent("config-changed", { detail: s })
    );
  }
...
var Wn = Object.defineProperty, Kn = Object.getOwnPropertyDescriptor, W = (t, e, s, i) => {
  for (var o = i > 1 ? void 0 : i ? Kn(e, s) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (o = (i ? a(e, s, o) : a(o)) || o);
  return i && o && Wn(e, s, o), o;
};
...
let U = class extends Y {
  ...
  _classesForArea(t, e, s, i, o) {
    ...
    const n = ae(i, o), a = n ? _s : ce(t, o), r = re(
      ...
      void 0,
      n
    ), c = ((m = this._config) == null ? void 0 : m.extra_entities) || [], h = r.map((l) => this.hass.states[l]).filter((l) => l !== void 0);
    if (e === "toggle") {
      const l = h.filter(
        (_) => Qe.includes(I(_.entity_id)) || Lt.includes(I(_.entity_id))
      );
      return [...new Set(l.map((_) => I(_.entity_id)))];
    }
    if (e === "all") {
      const l = c.map((p) => this.hass.states[p]).filter((p) => p !== void 0), _ = [...h, ...l];
      return [...new Set(_.map((p) => I(p.entity_id)))];
    }
    const u = h.filter(
      (l) => {
        var _;
        return I(l.entity_id) === e && !((_ = i[l.entity_id]) != null && _.entity_category);
      }
    ).map((l) => l.attributes.device_class || "").filter(
      (l) => l && (e !== "sensor" || !s || s.includes(l))
    );
    return [...new Set(u)];
  }
  _buildOptions(t, e, s) {
  ...
  async updated(t) {
    ...
    if (super.updated(t), !(!this.hass || !this._config)) {
      if (t.has("_config")) {
        const s = t.get("_config"), i = s == null ? void 0 : s.area, o = this._config.area, n = (s == null ? void 0 : s.extra_entities) || [], a = this._config.extra_entities || [], r = (s == null ? void 0 : s.popup_domains) || [], c = ((e = this._config) == null ? void 0 : e.popup_domains) || [], h = n.length !== a.length || !n.every(
          (u) => a.includes(u)
        ), d = r.length !== c.length || !r.every(
          (u) => c.includes(u)
        );
        if (i !== void 0 && i !== o) {
          const u = this._toggleDomainsForArea(
            o,
            this.hass.entities,
            this.hass.devices
            ...
            this.hass.entities,
            this.hass.devices
          ), l = this._coverClassesForArea(
            o,
            this.hass.entities,
            this.hass.devices
          ), _ = this._allDomainsForArea(
            o,
            this.hass.entities,
            this.hass.devices
          ), p = u.sort(
            (V, v) => Qe.indexOf(V) - Qe.indexOf(v)
          ), f = Object.keys(Ze || {}), L = new Map(
            f.map((V, v) => [V, v])
          ), $ = _.sort((V, v) => {
            const b = L.has(V) ? L.get(V) : Number.MAX_SAFE_INTEGER, w = L.has(v) ? L.get(v) : Number.MAX_SAFE_INTEGER;
            return b === w ? V.localeCompare(v) : b - w;
          });
          if (this._config.toggle_domains = [
            ...p.filter((V) => V !== "scene" && V !== "script")
          ], this._config.alert_classes = [...m], this._config.cover_classes = [...l], this._config.popup_domains = [...$], this._config.customization_domain = [], this._config.customization_alert = [], this._config.customization_cover = [], this._config.customization_sensor = [], this._updateEntityOptions(), Array.isArray(this._config.hidden_entities)) {
            const V = this._config.hidden_entities, v = Object.values(this._hiddenEntitiesByDomain()).flat(), b = V.filter((w) => v.includes(w));
            b.length !== V.length && (this._config = {
              ...this._config || {},
              hidden_entities: b
  ...
  _renderSubElementEditor(t, e, s) {
    var d, u, m;
    const i = `customization_${t}`, o = (d = this._config) == null ? void 0 : d[i], n = `_subElementEditor${t.charAt(0).toUpperCase() + t.slice(1)}`, a = ((u = this[n]) == null ? void 0 : u.index) ?? 0, r = ((m = o == null ? void 0 : o[a]) == null ? void 0 : m.type) ?? "unknown", c = r.match(/^(.+?)\s*-\s*(.+)$/);
    let h;
    if (c) {
      const l = c[1].toLowerCase().replace(" ", "_"), _ = c[2].toLowerCase(), p = this.hass.localize(`component.${l}.entity_component._.name`) || c[1];
      let f = this.hass.localize(
        `ui.dialogs.entity_registry.editor.device_classes.${l}.${_}`
      ) || c[2];
      f = f.charAt(0).toUpperCase() + f.slice(1), h = `${p} – ${f}`;
    } else {
      let l = this.hass.localize(`component.${r}.entity_component._.name`) || r;
      l = l.charAt(0).toUpperCase() + l.slice(1), h = l;
    }
    return g`
      <div class="header">
        <div class="back-title">
  ...
  _groupByDeviceClass(t, e) {
    ...
    for (const h of e) {
      const d = ((c = (r = s[h]) == null ? void 0 : r.attributes) == null ? void 0 : c.device_class) || "";
      d && (i[d] || (i[d] = []), i[d].push(h));
    }
    const o = Ve(s, this.hass.locale.language);
    return Object.keys(i).sort((h, d) => h.localeCompare(d)).map((h) => ({
      deviceClass: h,
      label: this._getDeviceClassLabel(t, h),
      entities: i[h].slice().sort(o)
    }));
  }
  _hiddenEntitiesByDomain() {
    ...
    const s = ((m = this.hass) == null ? void 0 : m.entities) || {}, i = ((l = this.hass) == null ? void 0 : l.devices) || {}, o = (_ = this.hass) != null && _.areas ? Object.values(this.hass.areas) : [], n = (p = this._config) == null ? void 0 : p.area, a = (f = this._config) == null ? void 0 : f.floor, r = (L = this._config) == null ? void 0 : L.label, c = n ? Array.isArray(n) ? n : [n] : [], h = a ? Array.isArray(a) ? a : [a] : [], d = r ? Array.isArray(r) ? r : [r] : [];
    for (const $ of e) {
      const V = I($), v = s[$], b = v != null && v.device_id ? i[v.device_id] : void 0;
      if (((v == null ? void 0 : v.area_id) != null || (b == null ? void 0 : b.area_id) != null) && !(d.length && !(Array.isArray(v == null ? void 0 : v.labels) && v.labels.some((M) => d.includes(M)) || Array.isArray(b == null ? void 0 : b.labels) && b.labels.some((M) => d.includes(M)))) && !(c.length && !(v != null && v.area_id && c.includes(v.area_id) || b != null && b.area_id && c.includes(b.area_id)))) {
        if (h.length) {
          const k = (v == null ? void 0 : v.area_id) && o.some(
            (y) => y.area_id === v.area_id && y.floor_id && h.includes(y.floor_id)
          ), M = (b == null ? void 0 : b.area_id) && o.some(
            (y) => y.area_id === b.area_id && y.floor_id && h.includes(y.floor_id)
          );
          if (!k && !M) continue;
        }
        t[V] || (t[V] = []), t[V].push($);
  ...
  render() {
    ...
    const t = this._toggleDomainsForArea(
      ...
      o,
      this.hass.locale.language
    ), a = this._binaryschema(this.binarySelectOptions), r = this._coverschema(this.coverSelectOptions), c = this._sensorschema(this.sensorSelectOptions), h = this._toggleschema(this.toggleSelectOptions), d = this._popupschema(
        ...
        selector: {
          select: {
            ...
            mode: "dropdown"
                      ...
                      .computeLabel=${this.computeLabel}
                      @value-changed=${(l) => this._hiddenCategoryChanged(l)}
                    ></ha-form>
      ...
      (l) => g`
                        <ha-expansion-panel outlined class="domain-panel">
                          <div slot="header" class="domain-header">
                            <ha-svg-icon
                              .path=${this._domainIcon(l.domain, "on")}
                            ></ha-svg-icon>
                            <span class="domain-title"
                              >${this._domainLabel(l.domain)}</span
                            >
                          </div>
                          <div class="content">
                            ${["binary_sensor", "cover"].includes(l.domain) ? this._groupByDeviceClass(
        l.domain,
        l.entities
      ).map(
        (_) => g`
            ...
            return g`
                                            <div class="entity-row">
                                              <span class="entity-name">
                                                ${((L = (f = this.hass.states[p]) == null ? void 0 : f.attributes) == null ? void 0 : L.friendly_name) || p}
                                              </span>
                                              <ha-icon-button
                                                .path=${this._isHiddenEntity(p) ? pt : O1}
        ...
        (_) => {
          ...
          return g`
                                    <div class="entity-row">
                                      <span class="entity-name">
                                        ${((f = (p = this.hass.states[_]) == null ? void 0 : p.attributes) == null ? void 0 : f.friendly_name) || _}
                                      </span>
                                      <ha-icon-button
                                        .path=${this._isHiddenEntity(_) ? pt : O1}
            ...
            "ui.common.hide"
                                      ...
                                      ></ha-icon-button>
                                      <ha-icon-button
                                        .path=${this._isExcludedEntity(_) ? k1 : P1}
