...
be.elementStyles = [], be.shadowRootOptions = { mode: "open" }, be[Pe("elementProperties")] = /* @__PURE__ */ new Map(), be[Pe("finalized")] = /* @__PURE__ */ new Map(), ct == null || ct({ ReactiveElement: be }), (le.reactiveElementVersions ?? (le.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const De = globalThis, st = De.trustedTypes, o1 = st ? st.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, Cs = "$lit$", ne = `lit$${Math.random().toFixed(9).slice(2)}$`, vs = "?" + ne, Zs = `<${vs}>`, ve = document, ze = () => ve.createComment(""), Ie = (t) => t === null || typeof t != "object" && typeof t != "function", Pt = Array.isArray, Bs = (t) => Pt(t) || typeof (t == null ? void 0 : t[Symbol.iterator]) == "function", lt = `[ 	
\f\r]`, ke = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, n1 = /-->/g, a1 = />/g, me = RegExp(`>|${lt}(?:([^\\s"'>=/]+)(${lt}*=${lt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), r1 = /'/g, c1 = /"/g, ys = /^(?:script|style|textarea|title)$/i, Ns = (t) => (e, ...s) => ({ _$litType$: t, strings: e, values: s }), g = Ns(1), X = Symbol.for("lit-noChange"), v = Symbol.for("lit-nothing"), l1 = /* @__PURE__ */ new WeakMap(), ge = ve.createTreeWalker(ve, 129);
function Ls(t, e) {
...
const Rs = (t, e) => {
  ...
  for (let r = 0; r < s; r++) {
    const c = t[r];
    let h, l, d = -1, _ = 0;
    for (; _ < c.length && (a.lastIndex = _, l = a.exec(c), l !== null); ) _ = a.lastIndex, a === ke ? l[1] === "!--" ? a = n1 : l[1] !== void 0 ? a = a1 : l[2] !== void 0 ? (ys.test(l[2]) && (o = RegExp("</" + l[2], "g")), a = me) : l[3] !== void 0 && (a = me) : a === me ? l[0] === ">" ? (a = o ?? ke, d = -1) : l[1] === void 0 ? d = -2 : (d = a.lastIndex - l[2].length, h = l[1], a = l[3] === void 0 ? me : l[3] === '"' ? c1 : r1) : a === c1 || a === r1 ? a = me : a === n1 || a === a1 ? a = ke : (a = me, o = void 0);
    const p = a === me && t[r + 1].startsWith("/>") ? " " : "";
    n += a === ke ? c + Zs : d >= 0 ? (i.push(h), c.slice(0, d) + Cs + c.slice(d) + ne + p) : c + ne + (d === -2 ? r : p);
  }
...
class Te {
  constructor({ strings: e, _$litType$: s }, i) {
    ...
    this.parts = [];
    let n = 0, a = 0;
    const r = e.length - 1, c = this.parts, [h, l] = Rs(e, s);
    ...
    for (; (o = ge.nextNode()) !== null && c.length < r; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const d of o.getAttributeNames()) if (d.endsWith(Cs)) {
          const _ = l[a++], p = o.getAttribute(d).split(ne), m = /([.?@])?(.*)/.exec(_);
          c.push({ type: 1, index: n, name: m[2], strings: p, ctor: m[1] === "." ? Us : m[1] === "?" ? js : m[1] === "@" ? Ws : nt }), o.removeAttribute(d);
        } else d.startsWith(ne) && (c.push({ type: 6, index: n }), o.removeAttribute(d));
        if (ys.test(o.tagName)) {
          const d = o.textContent.split(ne), _ = d.length - 1;
          if (_ > 0) {
            o.textContent = st ? st.emptyScript : "";
            for (let p = 0; p < _; p++) o.append(d[p], ze()), ge.nextNode(), c.push({ type: 2, index: ++n });
            o.append(d[_], ze());
          }
        }
        ...
        let d = -1;
        for (; (d = o.data.indexOf(ne, d + 1)) !== -1; ) c.push({ type: 7, index: n }), d += ne.length - 1;
      }
      n++;
    }
  }
...
let Fs = class {
  ...
  u(e) {
    ...
    for (; c !== void 0; ) {
      if (a === c.index) {
        let h;
        c.type === 2 ? h = new xe(n, n.nextSibling, this, e) : c.type === 1 ? h = new c.ctor(n, c.name, c.strings, this, e) : c.type === 6 && (h = new Ks(n, this, e)), this._$AV.push(h), c = i[++r];
      }
...
class xe {
  ...
  _$AI(e, s = this) {
    e = Me(this, e, s), Ie(e) ? e === v || e == null || e === "" ? (this._$AH !== v && this._$AR(), this._$AH = v) : e !== this._$AH && e !== X && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Bs(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== v && Ie(this._$AH) ? this._$AA.nextSibling.data = e : this.T(ve.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var n;
...
class nt {
  ...
  _$AI(e, s = this, i, o) {
    ...
    if (n === void 0) e = Me(this, e, s, 0), a = !Ie(e) || e !== this._$AH && e !== X, a && (this._$AH = e);
      ...
      const r = e;
      let c, h;
      for (e = n[0], c = 0; c < n.length - 1; c++) h = Me(this, r[i + c], s, c), h === X && (h = this._$AH[c]), a || (a = !Ie(h) || h !== this._$AH[c]), h === v ? e = v : e !== v && (e += (h ?? "") + n[c + 1]), this._$AH[c] = h;
    }
    a && !o && this.j(e);
  }
  j(e) {
...
const Gs = { I: xe }, ht = De.litHtmlPolyfillSupport;
  ...
  update(t, [e]) {
    ...
    if (s !== null && (i === null || s !== i)) {
      ...
      if (n === void 0) {
        ...
        n = As(v, a), n.setConnected(!1), this.et.set(s, n);
      }
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const bs = "important", ti = " !" + bs, E = Ne(class extends Re {
  constructor(t) {
    var e;
...
const m1 = (t, e, s) => {
  ...
  update(t, [e, s, i]) {
    ...
    let h, l, d = 0, _ = o.length - 1, p = 0, m = n.length - 1;
    for (; d <= _ && p <= m; ) if (o[d] === null) d++;
    else if (o[_] === null) _--;
    else if (r[d] === a[p]) c[p] = _e(o[d], n[p]), d++, p++;
    else if (r[_] === a[m]) c[m] = _e(o[_], n[m]), _--, m--;
    else if (r[d] === a[m]) c[m] = _e(o[d], n[m]), fe(t, c[m + 1], o[d]), d++, m--;
    else if (r[_] === a[p]) c[p] = _e(o[_], n[p]), fe(t, o[d], o[_]), _--, p++;
    else if (h === void 0 && (h = m1(a, p, m), l = m1(r, d, _)), h.has(r[d])) if (h.has(r[_])) {
      const u = l.get(a[p]), f = u !== void 0 ? o[u] : null;
      if (f === null) {
        const L = fe(t, o[d]);
        _e(L, n[p]), c[p] = L;
      } else c[p] = _e(f, n[p]), fe(t, o[d], f), o[u] = null;
      p++;
    } else ut(o[_]), _--;
    else ut(o[d]), d++;
    for (; p <= m; ) {
...
const zt = ["sensor"], It = ["binary_sensor"], Tt = ["cover"], Lt = ["climate"], No = ["camera"], Qe = [
  ...
  if (typeof t == "object")
    return Object.entries(t).reduce((n, [a, r]) => {
      const c = a.startsWith("--") ? a : a.replace(/-([a-z])/g, (h, l) => l.toUpperCase());
  ...
  const o = t.replace(/\/\*[\s\S]*?\*\//g, "").replace(/\n/g, " ").split(";").map((n) => n.trim()).filter((n) => n && n.includes(":")).reduce((n, a) => {
    ...
    if (c && h !== void 0) {
      const l = c.trim(), d = l.startsWith("--") ? l : l.replace(/-([a-z])/g, (_, p) => p.toUpperCase());
      n[d] = h.trim();
    }
    return n;
  }, {});
  return e && e.set(s, o), o;
}, $s = (t, e, s) => e && e._parsedCss ? e._parsedCss : t ? Vs(t, s) : {}, Wo = b(
  (t, e, s, i, o) => {
    const n = {
...
`, Q = [
  ...
  if (n && n !== "default" && ((_ = e == null ? void 0 : e.themes) != null && _[n])) {
    ...
    return;
  const h = ((m = t.__themes) == null ? void 0 : m.keys) || /* @__PURE__ */ new Set(), l = new Set(Object.keys(c));
...
const Ct = (t, e) => {
  ...
  if (e === "domain") {
    const _ = r === "toggle" || (r == null ? void 0 : r.action) === "toggle", p = r === "more-info" || (r == null ? void 0 : r.action) === "more-info";
    if (_) {
      ...
      if (s !== "binary_sensor" && s !== "sensor")
        if (s === "climate") {
          const u = (d = (l = t._config) == null ? void 0 : l.customization_domain) == null ? void 0 : d.find(
            (L) => L.type === "climate"
          ), f = u == null ? void 0 : u.display_mode;
...
const Ht = (t, e) => {
  ...
  if (!s || s.length === 0)
    return;
  let n;
  const a = s.filter((l) => !pn(l) || isNaN(Number(l.state)) ? !1 : n ? l.attributes.unit_of_measurement === n : (n = l.attributes.unit_of_measurement, !0));
  if (!a.length)
    return;
  const r = a.reduce((l, d) => l + Number(d.state), 0);
  let c;
  if (o)
    for (const l of a) {
      const d = o[l.entity_id], _ = fn(l, d);
      (_ == null ? void 0 : _.maximumFractionDigits) != null && (c == null || _.maximumFractionDigits > c) && (c = _.maximumFractionDigits);
    }
  c == null && (c = 1);
  const h = {
...
const xn = /* @__PURE__ */ new Set(), Sn = [ee, Q], Bt = class Bt extends Y {
    ...
    super(...arguments), this._onPopState = (e) => {
      ...
      (e, s, i, o, n, a, r) => {
        const c = new Set(
          ...
          r
        ), l = s == null ? void 0 : s.category_filter, d = (_) => $e(_, e, l);
        return h.filter((_) => {
          if (!d(_)) return !1;
          const p = I(_);
  ...
  async _createCardElement(e, s, i = !1) {
    ...
    try {
      ...
      return typeof l.setConfig == "function" && l.setConfig(s), l.hass = e, (a = l.setAttribute) == null || a.call(l, "data-hui-card", ""), l;
    } catch {
      if (!i)
  ...
  _getPopupCardConfig(e) {
    var p, m, u, f, L, $, V, C, A, w, k;
    const s = this.card, i = I(e.entity_id), o = this.selectedDomain || i, n = this.selectedDomain ? this.selectedDeviceClass : (f = (u = (m = (p = this.hass) == null ? void 0 : p.states) == null ? void 0 : m[e.entity_id]) == null ? void 0 : u.attributes) == null ? void 0 : f.device_class, a = (s == null ? void 0 : s._config) || {};
    let r;
    It.includes(o) ? (r = (L = a.customization_alert) == null ? void 0 : L.find(
      ...
      (M) => M.type === o
    ))) : Tt.includes(o) ? (r = (A = a.customization_cover) == null ? void 0 : A.find(
      (M) => M.type === n
    ...
    const c = r == null ? void 0 : r.popup_card, h = c && typeof c.type == "string" && c.type || (r == null ? void 0 : r.popup_card_type) || "tile", l = h === "tile" ? this.DOMAIN_FEATURES[i] ?? {} : {};
    let d = {};
  ...
  shouldUpdate(e) {
    ...
    const { areaId: o, devicesInArea: n, entitiesIndex: a } = this._getAreaEntitiesContext(), r = this._getCandidateEntityIds(
      ...
      a
    ), c = ((l = i._config) == null ? void 0 : l.extra_entities) || [];
    for (const d of r)
      if (!s.states[d] || s.states[d] !== this.hass.states[d])
        return !0;
    for (const d of c)
      if (!s.states[d] || s.states[d] !== this.hass.states[d])
        return !0;
  ...
  sortEntitiesForPopup(e) {
    ...
    if (s === "state") {
      ...
      return i.sort((c, h) => {
        const l = this._isActive(c) ? 0 : 1, d = this._isActive(h) ? 0 : 1;
        if (l !== d) return l - d;
        const _ = I(c.entity_id), p = I(h.entity_id), m = this.hass ? hs(this.hass, c.state, _) : c.state, u = this.hass ? hs(this.hass, h.state, p) : h.state, f = (m || "").localeCompare(u || "");
  ...
  render() {
    var A, w, k, M, y, S, z, T, P;
    if (!this.hass || !this.card) return g``;
    const e = this.card, { areaId: s, devicesInArea: i, entitiesIndex: o } = this._getAreaEntitiesContext(), n = this.hass.states, a = ((A = e._config) == null ? void 0 : A.popup_domains) || [], r = ((w = e._config) == null ? void 0 : w.extra_entities) || [], c = (k = e._config) == null ? void 0 : k.hide_unavailable, h = (M = e._config) == null ? void 0 : M.category_filter, l = this.selectedDomain || null, d = this.selectedDeviceClass || null, _ = (H) => $e(H, this.hass.entities, h);
    let p = [];
    this.entities && this.entities.length > 0 ? p = this.entities.reduce((H, O) => {
      const x = O.entity_id;
      if (!_(x)) return H;
      const B = I(x);
      return a.length > 0 && !a.includes(B) || l && B !== l || H.push(x), H;
    ...
    for (const H of p) {
      const O = n[H];
      O && (c && ee.includes(O.state) || d && O.attributes.device_class !== d || m.push(O));
    }
    for (const H of r) {
      const O = I(H), x = n[H];
      x && (a.length > 0 && !a.includes(O) || l && O !== l || d && x.attributes.device_class !== d || _(H) && !m.some((B) => B.entity_id === H) && m.push(x));
    }
    const u = ((y = e == null ? void 0 : e._config) == null ? void 0 : y.ungroup_areas) === !0;
    let f = (S = e._config) != null && S.columns ? e._config.columns : 4, L = [], $ = [];
    if (u)
      $ = this.sortEntitiesForPopup(m), f = Math.min(f, Math.max(1, $.length));
    else {
      const H = {};
      for (const R of m) {
        const G = I(R.entity_id);
        G in H || (H[G] = []), H[G].push(R);
      }
      const O = Object.keys(Ze || {}), x = a.length > 0 ? a : O;
      L = Object.entries(H).filter(([R]) => !l || R === l).sort(([R], [G]) => {
    ...
    if (this.style.setProperty("--columns", String(f)), !(L.length > 0 || $.length > 0))
      ...
      `;
    const C = Vt((z = e._config) == null ? void 0 : z.area, (T = e.hass) == null ? void 0 : T.areas) ?? null;
    return g`
      <ha-adaptive-dialog
        .hass=${this.hass}
        .open=${this.open}
      ...
      >
        ...
        <span slot="headerTitle">
          ${((P = e._config) == null ? void 0 : P.area_name) || C && C.name}
        </span>
...
let se = class extends Y {
  ...
  _isOn(t, e, s) {
    ...
    if (s)
      ...
      ).filter((l) => l.split(".")[0] === t).map((l) => this.hass.states[l]).filter((l) => l !== void 0);
    }
    if (i.length)
      return (e ? i.filter(
  ...
  _renderEntityGroup(t, e, s, i) {
    var l, d, _, p;
    const o = t === "cover", n = o ? "open" : "on", a = o ? (l = this._config) == null ? void 0 : l.cover_color : (d = this._config) == null ? void 0 : d.alert_color, r = o ? (_ = this._config) == null ? void 0 : _.cover_css : (p = this._config) == null ? void 0 : p.alert_css, c = o ? "cover" : "alert", h = o ? (m, u) => Mn(this, m, u) : (m, u) => $n(this, m, u);
    return g`
      <div class="${J({ [t + "s"]: !0, ...this._designClasses })}">
        ${te(
      e,
      (m) => m.domain + "-" + m.deviceClass,
      ({ domain: m, deviceClass: u }) => {
        var k, M, y, S, z, T;
        const f = i.get(u), L = (f == null ? void 0 : f.invert) === !0, V = (((k = s.get(m)) == null ? void 0 : k.get(u)) || []).filter((P) => {
          var O;
          const H = P.state === n;
        ...
        }), C = (f == null ? void 0 : f.color) || a, A = f == null ? void 0 : f.icon, w = V.length;
        return w > 0 ? g`
                  <div
  ...
  _renderSingleCustomButton(t, e) {
    var r, c, h, l, d, _;
    if (t.conditional) {
      const p = t.entity ? I(t.entity) : null;
      if (p && p in e) {
        const m = e[p].find(
          (u) => u.entity_id === t.entity
        );
        if (!m || ee.includes(m.state) || Q.includes(m.state))
          return v;
      }
    }
    if (t.state_mode && t.entity && t.state_value) {
      const p = this.hass.states[t.entity];
      if (!p) return v;
      const m = p.state === t.state_value;
    ...
    if (!n && s && (n = s.attributes.icon, !n)) {
      const p = I(s.entity_id), m = !ee.includes(s.state) && !Q.includes(s.state);
      n = us(p, m, s.attributes.device_class);
    }
    const a = !!t.name;
    return g`
      <div
      ...
      >
        ${t.use_entity_picture && ((h = s == null ? void 0 : s.attributes) != null && h.entity_picture) ? g`<img
                    ...
                    style=${E({
      ...this._getParsedCss(((l = t.styles) == null ? void 0 : l.icon) || t.icon_css, t)
    })}
                  />` : n ? this._renderIcon(
      n,
      E({
      ...
      ...o,
      ...this._getParsedCss((_ = t.styles) == null ? void 0 : _.name, t)
    })}"
                    >${t.name}</span
                  >` : v}
      </div>
  ...
  renderPositionedCustomButtons(t) {
    ...
    return e.length === 0 ? v : g`
      ${e.map((i) => {
      var a, r;
      const o = (c) => c && !/[^0-9]/.test(c) ? `${c}px` : c, n = i.position === "custom" ? {
        ...i.position_top ? { top: o(i.position_top) } : {},
        ...i.position_right ? { right: o(i.position_right) } : {},
        ...i.position_bottom ? { bottom: o(i.position_bottom) } : {},
        ...i.position_left ? { left: o(i.position_left) } : {}
      } : {};
      return g`
          <div
            class="positioned-button ${i.position !== "custom" ? i.position : ""}"
            style=${E({
        ...n,
        ...this._getParsedCss(((a = i.styles) == null ? void 0 : a.button) || ((r = i.styles) == null ? void 0 : r.card) || i.css, i)
      })}
          >
            ${this._renderSingleCustomButton(i, t)}
          </div>
        `;
    })}
    `;
  ...
  _renderButtons(t, e, s) {
    return g`
      ...
      (i) => i,
      (i) => {
        var u, f, L, $, V, C, A, w, k, M;
        if (i === "climate") {
          const y = s.get("climate"), S = y == null ? void 0 : y.display_mode;
          if (y && y.hide === !0 || S !== "icon" && S !== "text_icon")
            return v;
        }
        const o = s.get(i), n = (o == null ? void 0 : o.color) || ((u = this._config) == null ? void 0 : u.domain_color), a = o == null ? void 0 : o.icon, r = i === "climate" ? s.get("climate") : void 0, c = r == null ? void 0 : r.display_mode, h = r == null ? void 0 : r.show_set_temperature, l = i === "climate" && (c === "icon" || c === "text_icon") && h === !0, d = e[i].filter((y) => !(ee.includes(y.state) || this._excludedEntitiesSet.has(y.entity_id)));
        let _ = [], p;
        if (l) {
          _ = d;
          let y = !1, S = !1;
          ...
          y ? p = this._getClimateColor("heat", "red") : S ? p = this._getClimateColor("cool", "cornflowerblue") : p = this._getClimateColor("standby", "") || ((L = this._config) == null ? void 0 : L.climate_standby_color);
        } else
          _ = d.filter((y) => {
            var S;
            if (i === "climate") {
        ...
        const m = _.length;
        return this._config.show_active && m === 0 ? v : g`
              <div
                class="icon-with-count hover"
                style=${E(
          this._getParsedCss(
            (($ = o == null ? void 0 : o.styles) == null ? void 0 : $.button) || ((V = o == null ? void 0 : o.styles) == null ? void 0 : V.card) || (o == null ? void 0 : o.css) || ((C = this._config) == null ? void 0 : C.domain_css) || ((w = (A = this._config) == null ? void 0 : A.styles) == null ? void 0 : w.domain),
            o
          )
        )}
                @action=${Ct(this, i)}
  ...
  _renderSensors(t, e, s, i, o) {
    ...
    return g`
      ...
      ({ domain: c, deviceClass: h, index: l }) => {
        var A, w, k, M, y, S, z, T, P, H, O;
        const _ = (((A = s.get(c)) == null ? void 0 : A.get(h)) || []).filter(
          (x) => {
            var B;
        ...
        const m = p ? this.hass.states[p] : void 0, u = o.get(h), f = (u == null ? void 0 : u.color) || ((w = this._config) == null ? void 0 : w.sensor_color), L = (u == null ? void 0 : u.invert) === !0, $ = _.some(
        ...
        const V = (k = this._config) != null && k.show_sensor_icons ? g`<ha-domain-icon
          ...
          ...this._getParsedCss(
            ((z = u == null ? void 0 : u.styles) == null ? void 0 : z.sensor) || ((T = u == null ? void 0 : u.styles) == null ? void 0 : T.button) || ((P = u == null ? void 0 : u.styles) == null ? void 0 : P.card) || (u == null ? void 0 : u.css),
            u
          )
        })}
                >
                  ${!((H = this._config) != null && H.show_sensor_icons) && !((O = this._config) != null && O.wrap_sensor_icons) && l > 0 ? " - " : ""}
                  ${m ? this.hass.formatEntityState(m) : ds(
          c,
          h,
          _,
          this.hass.locale,
      ...
      ({ domain: i }) => {
        ...
        if ((n == null ? void 0 : n.show_set_temperature) === !0) {
          ...
          const f = u.reduce(
            ...
            ...this._getParsedCss(
              ((l = n == null ? void 0 : n.styles) == null ? void 0 : l.button) || ((d = n == null ? void 0 : n.styles) == null ? void 0 : d.card) || (n == null ? void 0 : n.css),
              n
            )
          };
          return g`<div
        ...
        const r = (o || []).filter((u) => {
          var A;
          const f = (A = u.attributes) == null ? void 0 : A.hvac_action, L = u.state, $ = !ee.includes(L) && !Q.includes(L) && !this._excludedEntitiesSet.has(u.entity_id);
          if (f != null) {
            const w = f.toString().toLowerCase();
            return $ && (w !== "idle" && w !== "off");
          }
          const V = (L ?? "").toString().toLowerCase(), C = V.includes("heat") || V.includes("cool") || V !== "idle" && V !== "off";
          return $ && C;
        }).map((u) => {
          var L, $, V, C;
          return `${((L = u.attributes) == null ? void 0 : L.temperature) ?? "N/A"} ${((C = (V = ($ = this.hass) == null ? void 0 : $.config) == null ? void 0 : V.unit_system) == null ? void 0 : C.temperature) || ""}`;
        });
        if (r.length === 0)
          return v;
        const c = n == null ? void 0 : n.color, h = {
          ...c ? { color: `var(--${c}-color)` } : {},
          ...!c && ((_ = this._config) != null && _.domain_color) ? { color: this._config.domain_color } : {},
          ...this._getParsedCss(
            ((p = n == null ? void 0 : n.styles) == null ? void 0 : p.button) || ((m = n == null ? void 0 : n.styles) == null ? void 0 : m.card) || (n == null ? void 0 : n.css),
            n
          )
        };
        return g`<div
  ...
  _renderBottom(t, e, s, i, o, n, a) {
    ...
    return g`
      ...
      ...this._getParsedCss(
        ((h = (c = this._config) == null ? void 0 : c.styles) == null ? void 0 : h.name) || ((l = this._config) == null ? void 0 : l.name_css),
        this._config
      )
    })}
  ...
  render() {
    var H, O, x, B, R, G, Se, Ee, Nt, Rt, Ft, Ut, jt, Wt;
    ...
    const d = Vt(this._config.area, ((B = this.hass) == null ? void 0 : B.areas) || {}), _ = this._customizationDomainMap, p = this._customizationCoverMap, m = this._customizationAlertMap, u = this._customizationSensorMap, f = this._computeCovers(l, this._deviceClasses), L = this._computeAlerts(l, this._deviceClasses), $ = this._computeButtons(
      this._config.toggle_domains,
      l
    ), V = this._computeSensors(l, this._deviceClasses), C = ((G = (R = this._config) == null ? void 0 : R.toggle_domains) != null && G.includes("climate") ? Lt : []).filter((j) => j in l).map((j) => ({ domain: j })), A = (((Se = this._config) == null ? void 0 : Se.display_type) || "").toString().toLowerCase(), w = A.includes("camera"), k = A.includes("picture") || A.includes("image"), M = A === "" ? !0 : A.includes("icon"), y = w ? l.camera || [] : [], S = w && (this._config.camera_entity || this._config.camera_entity_left || this._config.camera_entity_right);
    if (d === null)
      return g`
        <hui-warning>
      ...
      `;
    const z = w && (y.length > 0 || S) || k && d.picture, T = Wo(
      t,
      i,
    ...
    return g`
      ...
      if (w && y.length > 0) {
        ...
        if (at === "split") {
          const Le = ((Oe = this._config) == null ? void 0 : Oe.camera_entity_left) || ((Kt = y[0]) == null ? void 0 : Kt.entity_id), Ae = ((Gt = this._config) == null ? void 0 : Gt.camera_entity_right) || ((qt = y[1]) == null ? void 0 : qt.entity_id);
          if (Le && Ae)
            return g`
      ...
      this._renderBottom(
        ...
        ${this.renderPositionedCustomButtons(l)}
      </ha-card>
    `;
  }
  _showPopup(t, e, s) {
...
const kn = b(() => [{ name: "area", selector: { area: {} } }]), Pn = b(
  (t, e, s, i, o) => {
              ...
              select: {
                options: [
                  ...
                  const c = (d) => {
                    ...
                    return _ === "icon" ? "ui.panel.lovelace.editor.card.generic.icon" : _ === "picture" || _ === "image" ? "ui.components.selectors.image.image" : _ === "camera" ? "ui.panel.lovelace.editor.card.area.display_type_options.camera" : `ui.panel.lovelace.editor.card.area.display_type_options.${d}`;
                  }, l = r.split(" & ").map((d) => d.trim()).map((d) => n(c(d)) || d).join(" & ");
                  return { value: r, label: l };
                }),
                mode: "dropdown"
              }
            }
...
let ie = class extends Y {
  constructor() {
    super(...arguments), this.useSensorSchema = !1, this._activeTab = "config", this._schemadomainConfig = b(() => {
      var e;
      const t = [
    ...
    }), this._schemasensorConfig = b(() => [
      { name: "invert", selector: { boolean: {} } },
      {
        name: "color",
        selector: { ui_color: { default_color: "state", include_state: !0 } }
      }
    ]), this._schemasensorActions = b(() => {
      const t = Wn;
      return [
        {
          name: "tap_action",
    ...
    }), this._schemacustombuttonConfig = b(() => [
      { name: "entity", selector: { entity: {} } },
      { name: "name", selector: { text: {} } },
      { name: "icon", selector: { icon: {} } },
      { name: "use_entity_picture", selector: { boolean: {} } }
    ]), this._schemacustombuttonConfigAfter = b(() => [
      { name: "activate_state_color", selector: { boolean: {} } },
      {
        name: "color",
        selector: { ui_color: { default_color: "state", include_state: !0 } }
      }
    ]), this._schemacustombuttonActions = b(() => {
      const t = ms;
      return [
        {
          name: "tap_action",
...
icon:
  ...
  color: var(--primary-color);
      ...
      this._updatePositionField("position", l.detail.value);
                  ...
                  ></ha-selector>
                  ${((a = this._config) == null ? void 0 : a.position) === "custom" ? g`
      ...
      this._updatePositionField(
        ...
        l.detail.value
                      ...
                      ` : v}
                  ${(r = this._config) != null && r.entity ? g`
      ...
      select: {
        ...
        options: [
          ...
          { value: "not_equal", label: "State not equal" }
                            ...
                            .value=${((c = this._config) == null ? void 0 : c.state_mode) || ""}
                            .label=${"Invert State"}
                            @value-changed=${(l) => {
      ...
      state: { entity_id: this._config.entity }
                            ...
                            .value=${((h = this._config) == null ? void 0 : h.state_value) || ""}
                            .label=${"State"}
                            @value-changed=${(l) => {
...
let U = class extends Y {
  constructor() {
    super(...arguments), this._activeTab = "config", this._subElementEditorDomain = void 0, this._subElementEditorAlert = void 0, this._subElementEditorCover = void 0, this._subElementEditorSensor = void 0, this._subElementEditorCustomButton = void 0, this._computeLabelCallback = b(
      (t, e) => Ms(e, t)
    ), this.computeLabel = (t) => this._computeLabelCallback(t, this.hass), this._schema = b(
      (t, e, s, i, o, n) => {
        switch (t) {
          case "appearance":
            return Pn(
    ...
    ), this._binaryschema = b(
      (t) => zn(t)
    ), this._coverschema = b(
      (t) => In(t)
    ), this._sensorschema = b(
      (t) => Tn(t)
    ), this._toggleschema = b(
      (t) => Zn(t)
    ), this._popupschema = b(
      (t, e) => {
  ...
  _classesForArea(t, e, s, i, o) {
    ...
    const n = ae(i, o), a = n ? _s : ce(t, o), r = re(
      ...
      void 0,
      n
    ), c = ((_ = this._config) == null ? void 0 : _.extra_entities) || [], h = r.map((p) => this.hass.states[p]).filter((p) => p !== void 0);
    if (e === "toggle") {
      const p = h.filter(
        (m) => Qe.includes(I(m.entity_id)) || Lt.includes(I(m.entity_id))
      );
      return [...new Set(p.map((m) => I(m.entity_id)))];
    }
    if (e === "all") {
      const p = c.map((u) => this.hass.states[u]).filter((u) => u !== void 0), m = [...h, ...p];
      return [...new Set(m.map((u) => I(u.entity_id)))];
    }
    const d = h.filter(
      (p) => {
        var m;
        return I(p.entity_id) === e && !((m = i[p.entity_id]) != null && m.entity_category);
      }
      ...
      if (t.has("_config")) {
        ...
        if (i !== void 0 && i !== o) {
          const d = this._toggleDomainsForArea(
            ...
            const A = L.has(V) ? L.get(V) : Number.MAX_SAFE_INTEGER, w = L.has(C) ? L.get(C) : Number.MAX_SAFE_INTEGER;
            return A === w ? V.localeCompare(C) : A - w;
          });
          if (this._config.toggle_domains = [
            ...
            const V = this._config.hidden_entities, C = Object.values(this._hiddenEntitiesByDomain()).flat(), A = V.filter((w) => C.includes(w));
            A.length !== V.length && (this._config = {
              ...this._config || {},
              hidden_entities: A
  ...
  _renderSubElementEditor(t, e, s) {
    var l, d, _;
    const i = `customization_${t}`, o = (l = this._config) == null ? void 0 : l[i], n = `_subElementEditor${t.charAt(0).toUpperCase() + t.slice(1)}`, a = ((d = this[n]) == null ? void 0 : d.index) ?? 0, r = ((_ = o == null ? void 0 : o[a]) == null ? void 0 : _.type) ?? "unknown", c = r.match(/^(.+?)\s*-\s*(.+)$/);
    let h;
    if (c) {
      const p = c[1].toLowerCase().replace(" ", "_"), m = c[2].toLowerCase(), u = this.hass.localize(`component.${p}.entity_component._.name`) || c[1];
      let f = this.hass.localize(
        `ui.dialogs.entity_registry.editor.device_classes.${p}.${m}`
      ) || c[2];
      f = f.charAt(0).toUpperCase() + f.slice(1), h = `${u} – ${f}`;
    } else {
      let p = this.hass.localize(`component.${r}.entity_component._.name`) || r;
      p = p.charAt(0).toUpperCase() + p.slice(1), h = p;
    }
    return g`
      <div class="header">
        <div class="back-title">
  ...
  _groupByDeviceClass(t, e) {
    ...
    for (const h of e) {
      const l = ((c = (r = s[h]) == null ? void 0 : r.attributes) == null ? void 0 : c.device_class) || "";
      l && (i[l] || (i[l] = []), i[l].push(h));
    }
    const o = Ve(s, this.hass.locale.language);
    return Object.keys(i).sort((h, l) => h.localeCompare(l)).map((h) => ({
      deviceClass: h,
  ...
  _hiddenEntitiesByDomain() {
    ...
    const s = ((_ = this.hass) == null ? void 0 : _.entities) || {}, i = ((p = this.hass) == null ? void 0 : p.devices) || {}, o = (m = this.hass) != null && m.areas ? Object.values(this.hass.areas) : [], n = (u = this._config) == null ? void 0 : u.area, a = (f = this._config) == null ? void 0 : f.floor, r = (L = this._config) == null ? void 0 : L.label, c = n ? Array.isArray(n) ? n : [n] : [], h = a ? Array.isArray(a) ? a : [a] : [], l = r ? Array.isArray(r) ? r : [r] : [];
    for (const $ of e) {
      const V = I($), C = s[$], A = C != null && C.device_id ? i[C.device_id] : void 0;
      if (((C == null ? void 0 : C.area_id) != null || (A == null ? void 0 : A.area_id) != null) && !(l.length && !(Array.isArray(C == null ? void 0 : C.labels) && C.labels.some((M) => l.includes(M)) || Array.isArray(A == null ? void 0 : A.labels) && A.labels.some((M) => l.includes(M)))) && !(c.length && !(C != null && C.area_id && c.includes(C.area_id) || A != null && A.area_id && c.includes(A.area_id)))) {
        if (h.length) {
          const k = (C == null ? void 0 : C.area_id) && o.some(
            (y) => y.area_id === C.area_id && y.floor_id && h.includes(y.floor_id)
          ), M = (A == null ? void 0 : A.area_id) && o.some(
            (y) => y.area_id === A.area_id && y.floor_id && h.includes(y.floor_id)
          );
          if (!k && !M) continue;
        }
        t[V] || (t[V] = []), t[V].push($);
  ...
  render() {
    ...
    const t = this._toggleDomainsForArea(
      ...
      o,
      this.hass.locale.language
    ), a = this._binaryschema(this.binarySelectOptions), r = this._coverschema(this.coverSelectOptions), c = this._sensorschema(this.sensorSelectOptions), h = this._toggleschema(this.toggleSelectOptions), l = this._popupschema(
      ...
      (p) => g`
            ...
            return g`
                                            <div class="entity-row">
                                              <span class="entity-name">
                                                ${((L = (f = this.hass.states[u]) == null ? void 0 : f.attributes) == null ? void 0 : L.friendly_name) || u}
                                              </span>
                                              <ha-icon-button
        ...
        (m) => {
          ...
          return g`
                                    <div class="entity-row">
                                      <span class="entity-name">
                                        ${((f = (u = this.hass.states[m]) == null ? void 0 : u.attributes) == null ? void 0 : f.friendly_name) || m}
                                      </span>
                                      <ha-icon-button
                                        .path=${this._isHiddenEntity(m) ? pt : O1}
            ...
            "ui.common.hide"
                                      ...
                                      ></ha-icon-button>
                                      <ha-icon-button
                                        .path=${this._isExcludedEntity(m) ? k1 : P1}
