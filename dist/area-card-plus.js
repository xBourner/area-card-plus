 ...
 */
const tt = globalThis, St = tt.ShadowRoot && (tt.ShadyCSS === void 0 || tt.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Ot = Symbol(), Nt = /* @__PURE__ */ new WeakMap();
let ns = class {
  constructor(e, s, i) {
...
}, Rt = St ? (t) => t : (t) => t instanceof CSSStyleSheet ? ((e) => {
  let s = "";
...
const ts = /* @__PURE__ */ new Set(), Cn = [oe, ee], It = class It extends te {
  constructor() {
    super(...arguments), this._onPopState = (e) => {
      ...
      if (e && e.type !== "click" && e.type !== "popup-closed") {
        const s = e.target;
        if (s && s.tagName !== "HA-ADAPTIVE-DIALOG")
          return;
      }
  ...
  render() {
    var M, A, H, x, T, N, w, O, D, S, I, j, ce;
    ...
    this.entities && this.entities.length > 0 ? h = this.entities.reduce((E, R) => {
      ...
      if (!u(B)) return E;
      const ie = z(B);
      return a.length > 0 && !a.includes(ie) || d && ie !== d || E.push(B), E;
    ...
    for (const E of c) {
      const R = z(E), B = r[E];
      B && (a.length > 0 && !a.includes(R) || d && R !== d || _ && B.attributes.device_class !== _ || u(E) && !f.some((ie) => ie.entity_id === E) && f.push(B));
    }
    ...
    if (g)
      ...
      $ = Object.entries(E).filter(([W]) => !d || W === d).sort(([W], [J]) => {
        const Ee = B.indexOf(W), Se = B.indexOf(J);
        return (Ee === -1 ? B.length : Ee) - (Se === -1 ? B.length : Se);
      }).map(
...
let ue = class extends te {
      ...
      ({ domain: n }) => {
        ...
        if ((a == null ? void 0 : a.show_set_temperature) === !0) {
          const v = r.filter((C) => !this._excludedEntitiesSet.has(C.entity_id)).map((C) => {
            ...
            const A = ((ce = (j = (I = this.hass) == null ? void 0 : I.config) == null ? void 0 : j.unit_system) == null ? void 0 : ce.temperature) || "", H = ((E = C.attributes) == null ? void 0 : E.hvac_action) ?? null, x = (C.state ?? "").toString().toLowerCase(), T = (H ?? x).toString().toLowerCase(), N = T.includes("heat") || T.includes("heating"), w = T.includes("cool") || T.includes("cooling");
  ...
  render() {
    var O, D, S, I, j, ce, E, R, B, ie, W, J, Ee, Se, Zt, Bt;
    ...
    return m`
      <ha-card
        ...
        style=${P(
      this._getParsedCss(
        ((Zt = (Se = this._config) == null ? void 0 : Se.styles) == null ? void 0 : Zt.card) || ((Bt = this._config) == null ? void 0 : Bt.css),
        this._config
      )
    )}
      >
